...
* `html`: builds HTML guides with all contexts (`foreman-el`, `foreman-deb`, `containerized-katello`, `containerized-orcharhino`, `containerized-satellite`, `katello`, `orcharhino`, and `satellite`)
