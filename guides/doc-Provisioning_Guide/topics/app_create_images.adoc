...
This service must be enabled so that the {ProjectName} Server or {SmartProxyServer} can provide information about errata that are applicable for content hosts.
