...
For more information about installing a {RHEL} Workstation, see https://access.redhat.com/documentation/en-us/red_hat_enterprise_linux/7/html-single/installation_guide/index[{RHEL} 7 Installation Guide].
