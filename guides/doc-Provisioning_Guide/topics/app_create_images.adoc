...
+
  .. For the installation source, add an HTTP link to your repository in {ProjectName}, for example `satellite.example.com/pub/export/RHEL7/content/dist/rhel/server/7/7Server/x86_64/os/`
