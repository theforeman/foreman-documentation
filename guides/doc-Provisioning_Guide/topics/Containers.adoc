...
With {ProjectNameX}, you can create an on-premise registry, import images from various sources and distribute them to containers using Content Views. {ProjectServer} supports creating one or more Docker compute resources that act as servers for running containers. 
