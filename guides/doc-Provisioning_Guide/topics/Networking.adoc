...
To configure {Project} to use external DHCP, DNS, and TFTP services, see link:{InstallingProjectDocURL}configuring-external-services[Configuring External Services] in _{project-installation-guide-title}_.
