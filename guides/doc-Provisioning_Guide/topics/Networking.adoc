...
During DNS record creation, {Project} performs conflict DNS lookups to verify that hostname is not in active use. This check will be performed against one of the following DNS servers:
