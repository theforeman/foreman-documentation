...
For more information about synchronizing time in {Project}, see link:{InstallingProjectDocURL}synchronizing-the-system-clock-with-chronyd_{project-context}[Synchronizing Time] in _{project-installation-guide-title}_.
