...
For more information about synchronizing time in {Project}, see link:{InstallingProjectDocURL}installing-satellite-server-connected#synchronizing_time[Synchronizing Time] in _{project-installation-guide-title}_.
