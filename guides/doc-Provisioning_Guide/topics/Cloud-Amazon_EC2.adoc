...
For more information about synchronizing time in {Project}, see link:{BaseURL}installing_satellite_server_from_a_connected_network/installing_satellite_server#synchronizing_time[Synchronizing Time] in _{project-installation-guide-title}_.
