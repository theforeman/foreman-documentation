...
For more information, see link:{BaseURL}/planning_for_red_hat_satellite/chap-red_hat_satellite-architecture_guide-provisioning_concepts#http_booting_requirements[HTTP Booting Requirements] in _Planning for {Project}_.
