...
For more information about port and firewall requirements, see {BaseURL}installing_satellite_server_from_a_connected_network/preparing_your_environment_for_installation#ports-and-firewalls-requirements_satellite[Port and Firewall Requirements] in the _Installing {Project}_ and {BaseURL}installing_capsule_server/preparing-environment-for-capsule-installation#ports-and-firewalls-requirements_capsule[Ports and Firewalls Requirements] in _Installing {SmartProxyServer}_.
