...
* For boot-disk provisioning, click *Bood disk based*.
+
. Click *Resolve* in *Provisioning templates* to check the new host can identify the right provisioning templates to use.
. Click the *Virtual Machine* tab and confirm that these settings are populated with details from the host group and compute profile. Modify these settings to suit your needs. If you want to use boot-disk provisioning, select the *Add a CD-ROM drive to the virtual machine* check box.
