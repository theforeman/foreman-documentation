...
ifndef::satellite[]
include::common/modules/proc_creating-an-operating-system-for-debian.adoc[leveloffset=+2]
endif::[]
...
ifndef::satellite[]
include::common/modules/proc_creating-an-installation-medium-for-debian.adoc[leveloffset=+2]
endif::[]
