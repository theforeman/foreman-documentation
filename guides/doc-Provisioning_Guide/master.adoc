...
include::common/assembly_provisioning-cloud-instances-in-openstack.adoc[leveloffset=+1]

include::topics/Cloud-Amazon_EC2.adoc[]

include::common/assembly_provisioning-cloud-instances-in-gce.adoc[leveloffset=+1]

include::common/assembly_provisioning-cloud-instances-in-azure.adoc[leveloffset=+1]
