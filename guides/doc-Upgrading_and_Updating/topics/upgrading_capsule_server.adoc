...
. Finally, you must perform a complete synchronization of the upgraded {SmartProxy} as the MongoDB and RPM repositories are not automatically migrated with {Project}.
