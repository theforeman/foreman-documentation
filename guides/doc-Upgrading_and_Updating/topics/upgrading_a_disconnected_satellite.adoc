...
----
This removes Pulp 2 uploaded and synchronized packages, content in `/var/lib/pulp/content/`, the mongo database, and migration content in the Pulp 3 database.
