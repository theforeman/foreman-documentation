...
----
This removes uploaded and synchronized Pulp 2 packages, content in `/var/lib/pulp/content/`, the mongo database, and migration content in the Pulp 3 database.
