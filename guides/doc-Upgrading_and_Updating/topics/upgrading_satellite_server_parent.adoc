...
ifdef::satellite[]
If you have not migrated content from Pulp 2 to Pulp 3, you must upgrade to the latest version of {ProjectName} Server {ProjectVersionPrevious} before following the procedure in xref:migrating_pulp_content[].
endif::[]
