...
ifdef::satellite[]
.Upgrade Scenarios
- To upgrade a {ProjectServer} connected to the Red{nbsp}Hat Content Delivery Network, proceed to xref:upgrading_a_connected_satellite_server_{context}[].
- To upgrade a {ProjectServer} not connected to the Red{nbsp}Hat Content Delivery Network, proceed to xref:upgrading_a_disconnected_satellite_{context}[].
