...
[WARNING]
====
It is critical to run through the [Pulp 2 to Pulp 3 migration procedure](https://theforeman.org/plugins/katello/3.18/upgrade/index.html) before upgrading to Katello 4.0.

If you proceed without having gone through the migration proceedure, you will need to reinstall Katello or restore from backup.
====
endif::[]
