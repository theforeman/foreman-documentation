...
* Back up your {ProjectServer} and all {SmartProxyServer}s. For more information, see {SiteURL}/nightly/Administering_Red_Hat_Satellite/index-foreman-el.html#backing-up-satellite-server-and-capsule-server
endif:[]

ifeval::["{ProjectVersionPrevious}" != "2.3"]
* Back up your {ProjectServer} and all {SmartProxyServer}s. For more information, see {SiteURL}/{ProjectVersionPrevious}/Administering_Red_Hat_Satellite/index-foreman-el.html#backing-up-satellite-server-and-capsule-server
endif:[]
