...
. Power off the source server.
. Enter the following commands to register to the Customer Portal, attach subscriptions, enable only the required subscriptions, and enable the maintenance module:
+
[options="nowrap" subs="quotes,attributes"]
----
