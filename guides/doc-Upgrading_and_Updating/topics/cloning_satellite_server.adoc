...
For more information, see {InstallingServerDocURL}configuring-external-services[Configuring External Services on {ProjectServer}] in _Installing {ProjectServer}_.
...
For more information, see {AdministeringDocURL}Renaming_Server_admin[Renaming a {Project} or {SmartProxyServer}] in _Administrating {ProjectName}_.
