...
ifdef::satellite[]
* You must have migrated content from Pulp 2 to Pulp 3 before upgrading {ProjectServer} from {ProjectVersionPrevious} to {ProjectVersion}.
For further information, see xref:Migrating Content to Pulp 3[].
endif::[]
