...
ifndef::orcharhino[]
+
ifeval::["{ProjectVersionPrevious}" == "2.3"]
For more information about backups, see {SiteURL}/{ProjectVersion}/administering_red_hat_satellite/index-foreman-el.html#backing-up-satellite-server-and-capsule-server[Backing Up {ProjectServer} and {SmartProxyServer}] in the _Administering {ProjectName} {ProjectVersionPrevious}_ guide.
endif:[]

ifeval::["{ProjectVersionPrevious}" != "2.3"]
For more information about backups, see {SiteURL}/{ProjectVersionPrevious}/administering_red_hat_satellite/index-foreman-el.html#backing-up-satellite-server-and-capsule-server[Backing Up {ProjectServer} and {SmartProxyServer}] in the _Administering {ProjectName} {ProjectVersionPrevious}_ guide.
endif:[]
...
[options="nowrap" subs="attributes"]
----
# yum update -y https://fedorapeople.org/groups/katello/releases/yum/{KatelloVersion}/katello/el7/x86_64/katello-repos-latest.rpm
# yum update -y https://yum.theforeman.org/releases/{ProjectVersion}/el7/x86_64/foreman-release.rpm
# yum install -y centos-release-scl-rh
----
. Update packages
Clean the yum cache and update required packages
+
[options="nowrap" subs="attributes"]
----
# yum clean all
