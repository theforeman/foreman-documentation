...
+
For more information about configuring download policies, see {BaseURL}content_management_guide/importing_red_hat_content#changing_the_download_policy_for_a_repository[] in the _Content Management guide_.
+
