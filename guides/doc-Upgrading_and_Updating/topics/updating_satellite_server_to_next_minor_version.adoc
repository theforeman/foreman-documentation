...
----
# {foreman-maintain} upgrade check --target-version {ProductVersion}.z
----
+
...
[options="nowrap" subs="+quotes,attributes"]
----
# {foreman-maintain} upgrade run --target-version {ProductVersion}.z
----
...
[options="nowrap" subs="+quotes,attributes"]
----
# {foreman-maintain} upgrade check --whitelist="check-upstream-repository,repositories-validate" --target-version {ProductVersion}.z
----
+
. Review the results and address any highlighted error conditions before performing the upgrade.
...
[options="nowrap" subs="+quotes,attributes"]
----
# {foreman-maintain} upgrade run --whitelist="check-upstream-repository,repositories-setup,repositories-validate" --target-version {ProductVersion}.z
----
