...
// Pulp 3 Migration Guide
include::topics/preparing_to_migrate_pulp_content.adoc[leveloffset=+3]
...
//Validating Puppet Environments on the External SmartProxy Servers
include::common/modules/proc_validating-puppet-environments-on-the-external-smartproxy-servers.adoc[leveloffset=+2]
