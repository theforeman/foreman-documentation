...
include::common/modules/proc_migrating-to-a-new-server.adoc[leveloffset=+2]
endif::[]

ifdef::satellite[]
// Creating_a_Backup_of_a_Server_on_rhel7_
include::common/modules/proc_creating-a-backup-of-a-server-on-rhel7.adoc[leveloffset=+2]
endif::[]

ifdef::satellite[]
// Performing_a_Fresh_Installation_of_a_Server_on_rhel8_
include::common/modules/ref_performing-a-fresh-installation-of-a-server-on-rhel8.adoc[leveloffset=+2]
endif::[]

ifdef::satellite[]
// Restoring a Restoring_a_Backup_of_a_Server_on_rhel8_
include::common/modules/proc_restoring-a-backup-of-a-server-on-rhel8.adoc[leveloffset=+2]
endif::[]
