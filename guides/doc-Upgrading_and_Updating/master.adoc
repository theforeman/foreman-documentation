...
// Upgrading Foreman/Katello from Enterprise Linux 7 to Enterprise Linux 8 (LEAPP)
include::common/modules/proc_upgrading-project-from-el7-to-el8.adoc[leveloffset=+1]
endif::[]
