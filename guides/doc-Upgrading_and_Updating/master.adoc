...
include::topics/con_satellite-server-upgrade-scenarios-and-prerequisites.adoc[leveloffset=+2]

// Upgrading a Connected Satellite Server
include::topics/proc_upgrading-a-connected-satellite-server.adoc[leveloffset=+2]

ifdef::satellite[]
// Upgrading a Disconnected Satellite
include::topics/proc_upgrading-a-disconnected-satellite.adoc[leveloffset=+2]
endif::[]
