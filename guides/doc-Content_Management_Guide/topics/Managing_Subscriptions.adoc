...
=== Locating a Subscription in the Satellite Web UI
...
You must have a Subscription Manifest file imported to Satellite Server. For more information, see xref:importing-a-subscription-manifest-into-satellite-server_content-management[].
...
=== Adding Subscriptions to Subscription Allocations in the Satellite Web UI
...
=== Removing Subscriptions from Subscription Allocations in the  Satellite Web UI
...
In Satellite 6, you must maintain a Red{nbsp}Hat Enterprise Linux Smart Management subscription for every Red{nbsp}Hat Enterprise Linux host that you want to manage.
