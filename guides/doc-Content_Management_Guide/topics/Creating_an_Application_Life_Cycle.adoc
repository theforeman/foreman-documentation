...
image::001-Application_Life_Cycle.png[caption="The {ProjectNameX} Application Life Cycle", title="The {ProjectNameX} Application Life Cycle", alt="The {ProjectNameX} Application Life Cycle"]
