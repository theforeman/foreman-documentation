...
For more information, see {ManagingHostsDocURL}host-management-without-goferd-and-katello-agent_managing-hosts[Migrating from Katello Agent to Remote Execution] in the _Managing Hosts_ guide.
====
