...
. Synchronize the enabled content.
. When you have new content republish the Content Views that include this content (see xref:Managing_Content_Views_content-management[].) This should create a new Content View Version with the appropriate content to export.
