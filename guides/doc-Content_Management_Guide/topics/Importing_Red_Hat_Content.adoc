...
You can perform an initial synchronization using ISO images. For more information about using content ISOs, see xref:Importing_Content_ISOs_into_Connected_{Project}[].
