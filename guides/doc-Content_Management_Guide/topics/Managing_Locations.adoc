...
The location menu is the second menu item in the menu bar, on the upper left of the {Project} web UI. If you have not selected a current location, the menu displays *Any Location*. Click *Any location* and select the location to use.
