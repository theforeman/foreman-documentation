...
To use the CLI instead of the {ProjectWebUI}, see the xref:cli-adding-a-new-http-proxy_{context}[].
...
To use the CLI instead of the {ProjectWebUI}, see the xref:cli-creating-a-synchronization-plan_{context}[].
...
To use the CLI instead of the {ProjectWebUI}, see the xref:cli-importing-a-gpg-key_{context}[].
