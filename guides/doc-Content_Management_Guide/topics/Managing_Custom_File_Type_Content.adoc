...
[options="nowrap" subs="+quotes,attributes"]
----
# subscription-manager repos --enable {RepoRHEL7ServerSatelliteCapsuleProductVersion}
# {foreman-maintain} packages unlock
# yum install install python-pulp-manifest -y
# {foreman-maintain} packages lock
# subscription-manager repos --disable {RepoRHEL7ServerSatelliteCapsuleProductVersion}
----
