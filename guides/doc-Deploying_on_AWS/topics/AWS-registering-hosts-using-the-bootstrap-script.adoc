...
Install the Katello Agent. For more information, see {InstallingSmartProxyDocURL}installing-the-katello-agent_{smart-proxy-context}[Installing the katello Agent].
