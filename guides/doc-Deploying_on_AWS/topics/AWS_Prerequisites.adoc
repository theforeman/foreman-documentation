...
To install {SmartProxy} in an AWS environment, you must ensure that your AWS set up meets the {BaseURL}installing_capsule_server/preparing-environment-for-capsule-installation#system-requirements_capsule[System Requirements] in _{smart-proxy-installation-guide-title}_.
