...
To install {SmartProxy} in an AWS environment, you must ensure that your AWS set up meets the {InstallingSmartProxyDocURL}system-requirements_capsule[System Requirements] in _{smart-proxy-installation-guide-title}_.
