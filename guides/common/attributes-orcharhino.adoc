...
:ProjectVersion: 7.11
:ProjectVersionPrevious: 7.10
:ProjectVersionPrevious-Previous: 7.9
:Project: orcharhino
...
:project-server-context: orcharhino-server
...
:smart-proxies-context: orcharhino-proxy-servers
...
:smart-proxies-context: orcharhino-proxies
...
:client-package-manager: apt-get
