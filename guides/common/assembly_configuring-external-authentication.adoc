...
:context: keycloak-wildfly-config
include::assembly_configuring-keycloak-wildfly-authentication-for-project.adoc[leveloffset=+1]
ifdef::parent-context[:context: {parent-context}]
ifndef::parent-context[:!context:]

ifdef::context[:parent-context: {context}]
:context: keycloak-wildfly-login
include::assembly_logging-in-to-project-configured-with-keycloak-wildfly-as-an-authentication-source.adoc[leveloffset=+1]
ifdef::parent-context[:context: {parent-context}]
ifndef::parent-context[:!context:]
