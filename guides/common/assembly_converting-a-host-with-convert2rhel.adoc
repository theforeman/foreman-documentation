...
It subscribes the system to {Team} Subscription Management and {Project_Link} and replaces all packages signed by CentOS.
...
For more information, see https://access.redhat.com/documentation/en-us/red_hat_satellite/6.9/html/managing_hosts/registering_hosts#registering-a-host-to-project-using-the-global-registration-template_managing-hosts[Registering a Host to {ProjectName} Using the Global Registration Template] in the _Managing Hosts_ guide.
...
. xref:preparing-rhel-content_{context}[].
...
include::modules/proc_preparing-rhel-content.adoc[leveloffset=+1]
