...
Before you continue, consider which manifests are relevant for your environment. For more information on manifests, see {BaseURL}content_management_guide/managing_subscriptions/[Managing Subscriptions] in the _Content Management Guide_.
endif::[]
