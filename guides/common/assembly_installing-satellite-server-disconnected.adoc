...
ifdef::satellite[]
include::modules/con_installing-and-configuring-the-insights-advisor-engine-in-project-in-a-disconnected-environment.adoc[leveloffset=+1]

include::modules/proc_installing-the-insights-advisor-engine-in-project-in-a-disconnected-environment.adoc[leveloffset=+2]

include::modules/proc_installing-the-insights-advisor-engine-in-project-with-the-project-iso.adoc[leveloffset=+2]

include::modules/proc_installing-the-insights-advisor-engine-in-project-using-import-and-export.adoc[leveloffset=+2]
endif::[]

ifndef::satellite[]
include::modules/con_installing-and-configuring-the-advisor-engine-in-a-disconnected-environment.adoc[leveloffset=+1]

include::modules/proc_installing-the-advisor-engine-in-a-disconnected-environment.adoc[leveloffset=+2]

include::modules/proc_installing-the-advisor-engine-with-the-project-iso.adoc[leveloffset=+2]

include::modules/proc_installing-the-advisor-engine-using-import-and-export.adoc[leveloffset=+2]
endif::[]
