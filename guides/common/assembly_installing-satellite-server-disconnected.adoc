...
include::modules/con_installing-and-configuring-the-team-insights-on-premises-advisor-engine-in-a-disconnected-environment.adoc[leveloffset=+1]

ifdef::satellite[]
include::modules/proc_installing-the-insights-in-project-advisor-engine-in-a-disconnected-environment.adoc[leveloffset=+2]
endif::[]
...
include::modules/proc_installing-the-team-insights-on-premises-advisor-engine-with-the-project-iso.adoc[leveloffset=+2]

include::modules/proc_installing-the-team-insights-on-premises-advisor-engine-using-import-and-export.adoc[leveloffset=+2]
