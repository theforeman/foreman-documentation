...
include::modules/proc_configuring-minimal-data-collection-for-hosts.adoc[leveloffset=+1]

include::modules/proc_generating-insights-inventory-reports.adoc[leveloffset=+1]
