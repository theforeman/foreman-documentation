...
:ProductVersionRepoTitle: 6.9-beta
// For Beta, change to "Beta". For GA releases, change to, for example, "6.9".
...
:awx: AWX
:BaseURL: https://docs.theforeman.org/master/
