...
include::modules/proc_exporting-the-library-environment-syncable.adoc[leveloffset=+1]
...
include::modules/proc_exporting-a-content-view-version-syncable.adoc[leveloffset=+1]
...
include::modules/proc_exporting-a-repository-syncable.adoc[leveloffset=+1]
