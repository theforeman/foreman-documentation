...
include::modules/proc_using-a-third-party-repository-on-a-connected-server.adoc[leveloffset=+2]

include::modules/proc_using-a-third-party-repository-on-a-disconnected-server.adoc[leveloffset=+2]
