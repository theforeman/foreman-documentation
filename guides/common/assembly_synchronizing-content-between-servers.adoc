...
include::modules/proc_using-a-custom-repository-on-a-connected-server.adoc[leveloffset=+2]

include::modules/proc_using-a-custom-repository-on-a-disconnected-server.adoc[leveloffset=+2]
