...
// Host tools
include::modules/proc_configuring-openvox-agent-on-a-project-host-during-host-registration.adoc[leveloffset=+1]

include::modules/proc_configuring-openvox-agent-on-a-project-host-manually.adoc[leveloffset=+1]
