...
{ProjectName} can interact with Microsoft Azure Resource Manager, including creating new virtual machines and controlling their power management states. Only image-based provisioning, including provisioning using custom images is supported for creating Azure hosts.
