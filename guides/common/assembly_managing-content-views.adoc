...
include::modules/proc_enabling-dependency-solving-globally.adoc[leveloffset=+1]

include::modules/proc_enabling-dependency-solving-per-content-view.adoc[leveloffset=+1]
