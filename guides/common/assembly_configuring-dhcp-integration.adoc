...
include::common/modules/proc_configuring-for-uefi-http-boot-ipv6-provisioning.adoc[leveloffset=+1]
...
include::modules/proc_disabling-smart-proxy-dhcp-pinging.adoc[leveloffset=+1]
