...
include::modules/proc_configuring-dhcpd-to-use-with-server.adoc[leveloffset=+2]

include::modules/proc_configuring-server-for-use-with-dhcpd.adoc[leveloffset=+2]
