...
As part of the installation process for {ProjectName}, the *{foreman-installer}* command installs MongoDB and PostgreSQL databases on the same server as {Project}.
