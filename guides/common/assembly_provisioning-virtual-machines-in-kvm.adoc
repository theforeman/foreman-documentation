...
[id="provisioning-virtual-machines-in-kvm"]
= Provisioning Virtual Machines in KVM (libvirt)
...
. Optional: xref:adding-images-to-server_kvm-provisioning[]. Use this procedure if you want to use image-based provisioning.
