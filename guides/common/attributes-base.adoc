...
:project-client-el7-url: https://yum.theforeman.org/client/{ProjectVersion}/el7/x86_64/foreman-client-release.rpm
:project-client-el8-url: https://yum.theforeman.org/client/{ProjectVersion}/el8/x86_64/foreman-client-release.rpm
