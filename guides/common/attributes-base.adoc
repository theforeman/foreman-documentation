...
:RepoRHEL7ServerSatelliteServerProductVersion: rhel-7-server-satellite-6-beta-rpms
:RepoRHEL7ServerSatelliteServerProductVersionPrevious: rhel-7-server-satellite-6.9-rpms
:RepoRHEL7ServerSatelliteCapsuleProductVersion: rhel-7-server-satellite-capsule-6-beta-rpms
