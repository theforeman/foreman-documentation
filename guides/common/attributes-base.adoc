...
:UpgradingConnectedDocURL: {BaseURL}Upgrading_Connected_Project/{BaseFilenameURL}#
:UpgradingDisconnectedDocURL: {BaseURL}Upgrading_Disconnected_Project/{BaseFilenameURL}#
