...
// :RepoRHEL8Server: ???
//:RepoRHEL7ServerSoftwareCollections: rhel-server-rhscl-7-rpms - still valid??
...
// Satellite-Tools will become Satellite-Client ???
// :RepoRHEL7ServerOptional: any equivalent for Sat7???
// Ansible ??? - not mentioned i nthe doc with repo IDs
// Repos relevant for Puppet?
