...
:custompythonrepo: python repository
:custompythonrepoid: Python_Repository
:custompythonrepos: python repositories
:custompythonreposid: Python_Repositories
:custompythonrepostitle: Python Repositories
:custompythontype: python type
:custompythontypeid: Python_Type
:custompythontypetitle: Python Type
:customrpm: RPM
:customrpmtitle: RPM
:customssl: SSL
:customssltitle: SSL
