...
:ConfigureHostsAnsibleDocURL: {BaseURL}Configure_hosts_by_using_Ansible/{BaseFilenameURL}#
...
:ConfiguringVMSubscriptionsDocURL: {BaseURL}Configuring_virt_who_VM_Subscriptions/{BaseFilenameURL}#
...
:project-server-context: foreman-server
...
// Ansible Director plugin
:ansible-director-ansible-core-version: 2.20.4
:ansible-director-base-container-image-name: quay.io/fedora/fedora:44
