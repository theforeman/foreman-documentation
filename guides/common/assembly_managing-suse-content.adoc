...
include::modules/proc_removing-an-scc-account-by-using-web-ui.adoc[leveloffset=+1]

include::modules/proc_removing-an-scc-account-by-using-cli.adoc[leveloffset=+1]
