...
include::modules/con_smart-proxy-server-registration.adoc[leveloffset=+1]
...
include::modules/con_configuring-smart-proxy-servers-with-a-custom-ssl-certificate.adoc[leveloffset=+3]
...
include::modules/proc_proc_assign-organization-and-location-to-your-smart-proxy.adoc[leveloffset=+1]
