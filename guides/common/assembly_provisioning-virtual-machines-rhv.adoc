...
{oVirt} is an enterprise-grade server and desktop virtualization platform. In {ProjectName}, you can manage virtualization functions through {oVirt}'s REST API version 3. This includes creating virtual machines and controlling their power states.

REST API version 4 is not yet supported by {ProjectX}.
...
ifeval::["{build}" != "satellite"]
https://www.ovirt.org/documentation/vmm-guide/chap-Templates.html[Templates] in the {oVirt} documentation.
endif::[]
