...
Use the following procedures to install {ProjectServer}, perform the initial configuration, and import subscription manifests. For more information on subscription manifests, see {BaseURL}content_management_guide/managing_subscriptions/[Managing Subscriptions] in the _Content Management Guide_.
endif::[]
