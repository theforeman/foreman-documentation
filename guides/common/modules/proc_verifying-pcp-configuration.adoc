...
[id="verifying-pcp-configuration"]
= Verifying PCP configuration

[role="_abstract"]
Verify that PCP is configured correctly and all monitoring services are running to ensure data collection is working as expected.
