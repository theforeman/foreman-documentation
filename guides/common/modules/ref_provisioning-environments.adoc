...
[role="_abstract"]
You can create provisioning infrastructure in {ProjectName} by using Hammer CLI commands.
Set up domains, subnets, compute resources, and templates for automated host provisioning.
