...
[role="_abstract"]
Use Hammer CLI commands to create provisioning infrastructure in {ProjectName}.
Set up domains, subnets, compute resources, and templates for automated host provisioning by using these commands.
