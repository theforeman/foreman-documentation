...
For more information about updating packages on {ProjectServer}, see {UpgradingDocURL}updating_satellite_server_to_next_minor_version[Upgrading {ProjectServer} to the Next Minor Version] in _{UpgradingDocTitle}_.
