...
[id="adding-microsoft-azure-resource-manager-details-to-compute-profiles-by-using-hammer-cli"]
= Adding Microsoft Azure Resource Manager details to compute profiles by using Hammer CLI
