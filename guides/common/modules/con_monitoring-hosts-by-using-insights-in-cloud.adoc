...
* {Project} forwards information about your hosts through the Insights client to calculate recommendations.
* You can view those recommendations both on the {RHCloud} in the *Advisor* service and in the {ProjectWebUI}.
