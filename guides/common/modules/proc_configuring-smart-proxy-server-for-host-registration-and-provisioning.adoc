...
[id="configuring-{smart-proxy-context}-server-for-host-registration-and-provisioning_{context}"]
= Configuring {SmartProxyServer} for host registration and provisioning

[role="_abstract"]
Configure {SmartProxyServer} to register and provision hosts through your {SmartProxyServer} instead of your {ProjectServer}.
