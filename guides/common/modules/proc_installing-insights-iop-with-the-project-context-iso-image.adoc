...
ifdef::satellite[]
For more information, see {RHELDocsBaseURL}10/html/building_running_and_managing_containers/assembly_starting-with-containers_building-running-and-managing-containers#proc_getting-container-tools_assembly_starting-with-containers[Getting container tools] in _{RHEL}{nbsp}10 Building, running, and managing containers_.
endif::[]
ifndef::satellite[]
+
