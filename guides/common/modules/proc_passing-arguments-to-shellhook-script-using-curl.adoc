...
[role="_abstract"]
You can pass custom values to a shellhook script by using a curl request.
Use this when you need to test a script manually or call it directly, rather than through webhook automation.
