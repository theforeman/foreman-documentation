...
The {oVirt} compute resource will be officially phased out in the 3.16 release and this migration will be triggered automatically during the upgrade to 3.16.
