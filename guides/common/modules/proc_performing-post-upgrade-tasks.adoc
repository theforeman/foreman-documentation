...
Note that if you make manual edits to the DNS or DHCP configuration files, you must restart {Project} services with the `{foreman-maintain} service restart` command.
