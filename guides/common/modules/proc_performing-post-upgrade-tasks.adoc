...
* If you created backups of customized templates as described in xref:planning-{project-context}-upgrade[], verify the status of the templates on your upgraded {ProjectServer}.
