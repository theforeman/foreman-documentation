...
ifndef::satellite[]
{Team} also recommends removing the {oVirt} package by executing `{project-package-remove} foreman-ovirt` to prevent users from adding a new {oVirt} compute resource.
endif::[]
