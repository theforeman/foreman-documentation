...
* If you use templates that you created by cloning the default templates in {Project}, verify whether the default templates were changed during the upgrade.
If the default templates have changed, consider updating your customized templates to match the changes.
