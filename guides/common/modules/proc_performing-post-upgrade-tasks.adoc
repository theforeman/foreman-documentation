...
* If you created backups for your custom configuration as described in xref:backing-up-custom-{project-context}-server-configuration-before-upgrading[], restore your custom configuration.
