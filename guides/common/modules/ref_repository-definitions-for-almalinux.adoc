...
[role="_abstract"]
Use these example repository names and upstream URLs when you synchronize AlmaLinux BaseOS, AppStream, extras, and the optional {project-client-name} content.
