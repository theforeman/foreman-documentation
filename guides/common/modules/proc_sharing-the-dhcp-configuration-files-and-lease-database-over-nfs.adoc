...
Only then can {Project} access configuration settings, such as subnet definitions, and lease information that is not available over the ISC DHCP Object Management Application Programming Interface (OMAPI).
