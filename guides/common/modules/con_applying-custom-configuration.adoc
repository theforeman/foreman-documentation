...
For more information, see {InstallingServerDocURL}restoring-manual-changes-overwritten-by-a-puppet-run_{context}[Restoring Manual Changes Overwritten by a Puppet Run].
