...
[role="_abstract"]
You can use virtual machine snapshots to back up and restore your {SmartProxyServer}.
This is useful for quick recovery in case of server failure or configuration issues.
