...
[id="monitoring-{smart-proxy-context}-services"]
= Monitoring {SmartProxy} services

[role="_abstract"]
You can view the status and configuration details of {SmartProxy} services in {ProjectWebUI}.
This helps you verify that your {SmartProxy} services are running correctly and troubleshoot any issues.
...
For more information, see xref:monitoring-puppet-on-{smart-proxy-context}[].
