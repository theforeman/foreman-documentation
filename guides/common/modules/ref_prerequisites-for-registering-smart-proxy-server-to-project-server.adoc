...
** An activation key to assign to your {SmartProxy} during registration.
The activation key attaches a lifecycle environment and a content view to the {SmartProxy}.
...
ifdef::satellite[]
+
If you serve the {SmartProxy} container images from the Library environment through the Default Organization View, assign the Library environment and the Default Organization View to the activation key.
endif::[]
