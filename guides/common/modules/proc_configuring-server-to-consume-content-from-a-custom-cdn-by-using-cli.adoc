...
[id="configuring-{project-context}-server-to-consume-content-from-a-custom-cdn-by-using-cli"]
= Configuring {ProjectServer} to consume content from a custom CDN by using Hammer CLI
