...
.Prerequisites
* A host running {EL} 9 for PostgreSQL server.
...
----
. If your {ProjectServer} can reach the new database server by using the old name, you do not need to make any further changes.
