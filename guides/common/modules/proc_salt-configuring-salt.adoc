...
Once you've installed the Salt plugin, you need to connect it to a Salt Master.
...
[NOTE]
====
If you select Salt during step five of the xref:sources/installation_and_maintenance/orcharhino_installation_guide.adoc#oig_main_installation_steps[main orcharhino installation steps], the installer automatically performs those steps on your {Project}.
