...
[id="content-access-strategies"]
= Content access strategies

[role="_abstract"]
Control which content is accessible to your hosts using content views, lifecycle environments, content overrides, and architecture restrictions.
These strategies enable you to enforce precise software policies and manage content distribution across your infrastructure.

{Team} recommends considering implementing the strategies in the order as listed here:
...
For more information about setting system purpose attributes, see {ManagingHostsDocURL}editing-the-system-purpose-of-a-host-by-using-web-ui[Editing the system purpose of a host] in _{ManagingHostsDocTitle}_.
endif::[]
ifdef::orcharhino[]
ifdef::red_hat_enterprise_linux[]
Release version::
