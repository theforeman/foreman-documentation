...
For more information, see {InstallingServerDocURL}installing-and-configuring-red-hat-lightspeed-in-{project-context}[Installing and configuring {insights-iop}].
endif::[]
ifdef::satellite[]
...
+
If you intend to use {insights-iop}, enable it.
For more information, see {InstallingServerDisconnectedDocURL}installing-and-configuring-red-hat-lightspeed-in-{project-context}[Installing and configuring {insights-iop}].
endif::[]
