...
| 443 | TCP | HTTPS | cert.console.redhat.com | Red{nbsp}Hat Lightspeed | When using Red{nbsp}Hat Lightspeed, required for Inventory upload and Cloud Connector connection
