...
[role="_abstract"]
Discover container image repositories in an external registry from the {ProjectWebUI} to quickly import multiple repositories without entering each repository URL manually.
