...
[role="_abstract"]
Use minimal data collection to limit host data sent to Red{nbsp}Hat while keeping the Subscriptions service active.
Other {Insights} services are disabled because they require installed package data.
...
* Existing data in {Insights} Inventory has been deleted before switching to minimal reporting.
