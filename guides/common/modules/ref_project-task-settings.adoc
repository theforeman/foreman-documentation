...
[role="_abstract"]
The task settings define how {Project} manages background tasks, including timeouts, retry behavior, batch processing, and debugging options for the dynflow console.
