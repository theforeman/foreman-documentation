...
[role="_abstract"]
You can add errata to a host collection so that the errata are applied to all hosts in the collection in one action.

.Prerequisites
* The errata to be added should be available in one of the existing repositories or added before this procedure.
