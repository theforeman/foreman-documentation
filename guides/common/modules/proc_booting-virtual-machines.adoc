...
.Procedure
. In the {ProjectWebUI}, navigate to *Hosts*{nbsp}>{nbsp}*Provisioning Templates*, enter `Kickstart default iPXE` and click *Search*.
...
. In the {ProjectWebUI}, navigate to *Hosts*{nbsp}>{nbsp}*Operating systems* and select the operating system of your host.
