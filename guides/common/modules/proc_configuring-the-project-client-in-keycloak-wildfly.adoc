...
Use this procedure to configure the {Project} client in the {keycloak-wildfly} web UI and create group and audience mappers for the {Project} client.

.Procedure

. In the {keycloak-wildfly} web UI, navigate to the created {Project} realm, then *Clients* and click the {Project} client.
