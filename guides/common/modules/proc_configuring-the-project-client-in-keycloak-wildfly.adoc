...
In the {keycloak-wildfly} web UI:
...
* For more information about configuring {keycloak-wildfly} clients, see link:https://access.redhat.com/documentation/en-us/red_hat_single_sign-on/7.6/html-single/server_administration_guide/index[{keycloak-wildfly} _Server Administration Guide_].
endif::[]
