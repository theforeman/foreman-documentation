...
.Procedure
. In the {ProjectWebUI}, navigate to *Infrastructure*{nbsp}>{nbsp}*Realms* and click *Create Realm*.
...
. In the {ProjectWebUI}, navigate to *Configure*{nbsp}>{nbsp}*Host Groups*, select the host group that you want to update, and click the *Network* tab.
