...
* For more information about configuring {keycloak-quarkus} clients, see link:{RHDocsBaseURL}/24.0/html-single/server_administration_guide/index#assembly-managing-clients_server_administration_guide[{RHBK} _Server Administration Guide_].
endif::[]
