...
[role="_abstract"]
If you use older Salt Minions on your hosts with Salt Master {salt-version}, you must configure your Salt {SmartProxies} to accept a lower authentication version.
