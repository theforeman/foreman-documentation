...
[role="_abstract"]
You can install a pre-built Puppet module from the Puppet Forge or a private Puppet module that is not available on the Puppet Forge by manually coping the module to your {ProjectServer}.
