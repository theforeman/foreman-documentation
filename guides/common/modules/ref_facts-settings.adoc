...
| *Location fact* | {project_context}_location | Hosts created after a Puppet run are placed in the location specified by this fact.
| *Organization fact* | {project_context}_organization | Hosts created after a Puppet run are placed in the organization specified by this fact.
