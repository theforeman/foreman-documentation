...
.Verification
ifdef::foremanctl[]
* With the web UI, open the login page to your {ProjectServer} and inspect the certificate in the browser.
...
[options="nowrap" subs="+quotes,attributes"]
----
# openssl s_client -connect satellite.example.com:443
----
endif::[]
ifndef::foremanctl[]
ifndef::orcharhino[]
