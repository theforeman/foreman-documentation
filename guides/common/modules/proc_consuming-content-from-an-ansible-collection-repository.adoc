...
[role="_abstract"]
Configure hosts to consume content from an Ansible Collection repository on {ProjectServer} or {SmartProxyServer} to ensure consistent automation content across your infrastructure.
You can configure the Ansible Galaxy client to use your {ProjectServer} or {SmartProxyServer} as a Galaxy server.
