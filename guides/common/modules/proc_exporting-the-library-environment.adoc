...
[id="exporting-the-library-environment"]
= Exporting the Library environment

[role="_abstract"]
You can export all Library content for an organization to an archive file and recreate the same repositories on another {ProjectServer} or organization.
