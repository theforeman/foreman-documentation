...
[role="_abstract"]
Export the Library environment to archive files for replication across multiple {ProjectServer}s or organizations.
Library exports enable complete repository migration and disaster recovery scenarios.
