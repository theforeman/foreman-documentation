...
By default, {Project} assigns existing hosts and hosts during the global host registration workflow to the `Unassigned` resource quota.
This means that users did not assign the host to a specific pool of resources.
