...
[role="_abstract"]
You can use comparison operators such as EQUALS, LIKE, and GREATER THAN, along with logical operators AND, OR, and NOT, to build queries that filter and search for resources based on specific criteria.
