...
A role-based access control policy is a set of rules that defines which users can access which resources and what actions they can perform on those resources.
...
* {AdministeringDocURL}creating-and-managing-roles[Creating and managing roles in _{AdministeringDocTitle}_]
