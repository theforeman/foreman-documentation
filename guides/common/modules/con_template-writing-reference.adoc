...
Note that the default templates provided by {ProjectName} (*Hosts*{nbsp}>{nbsp}*Provisioning templates*, *Hosts*{nbsp}>{nbsp}*Job templates*, *Monitor*{nbsp}>{nbsp}*Report Templates* ) also provide a good source of ERB syntax examples.
