...
For more information, see {ProvisioningDocURL}creating-provisioning-templates-by-using-web-ui[Creating provisioning templates] in _{ProvisioningDocTitle}_.
...
For more information, see {ProvisioningDocURL}creating-partition-tables-by-using-web-ui_provisioning[Creating partition tables] in _{ProvisioningDocTitle}_.
