...
[NOTE]
====
Any {SmartProxyServer} base operating system is a client of the internal {SmartProxy} in your {ProjectServer}, and therefore this section applies to any type of host connected to {ProjectServer}, including {SmartProxyServers}.
====
