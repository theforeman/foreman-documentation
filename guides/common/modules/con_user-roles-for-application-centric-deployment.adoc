...
The ACD plug-in requires the specific {Project} permissions.
...
Note that the *Ansible playbook* is not related to the Ansible plug-in for configuration management.
