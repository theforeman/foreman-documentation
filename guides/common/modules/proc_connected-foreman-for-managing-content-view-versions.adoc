[id="Connected_{ProjectServer}_for_managing_Content_View_Versions"]
...
. When you have new content republish the Content Views that include this content (see xref:Managing_Content_Views[].)
