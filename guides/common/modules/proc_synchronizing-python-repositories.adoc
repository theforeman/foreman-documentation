...
[id="synchronizing-python-repositories"]
= Synchronizing Python repositories

[role="_abstract"]
Synchronize Python content to repositories in {Project} to distribute Python packages to your hosts.
You can synchronize Python repositories from any mirror and other {Project} instances.
