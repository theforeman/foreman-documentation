...
----
|Reverts `{foreman-maintain} unlock` and configures {Project} to ensure the stability of the base operating system by preventing users from managing packages with `dnf`.
|====
