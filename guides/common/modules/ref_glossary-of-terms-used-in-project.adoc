...
[[Discovery_plugin]]
Discovery plugin:: Automatically detects unknown bare-metal hosts on the provisioning network.
...
You can execute Hammer commands from the command line or use it in scripts.
