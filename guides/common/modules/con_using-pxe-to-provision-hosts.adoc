...
* xref:configuring-{project-context}-server-to-provision-almalinux-on-Secure-Boot-enabled-hosts[]
* xref:configuring-{project-context}-server-to-provision-debian-on-Secure-Boot-enabled-hosts[]
* xref:configuring-{project-context}-server-to-provision-rocky-on-Secure-Boot-enabled-hosts[]
* xref:configuring-{project-context}-server-to-provision-ubuntu-on-Secure-Boot-enabled-hosts[]
endif::[]
