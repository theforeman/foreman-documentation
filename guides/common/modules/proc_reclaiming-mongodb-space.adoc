...
* Back up the MongoDB database. For more information about backing up {Project}, see {AdministeringDocURL}backing-up-satellite-server-and-capsule-server[Backing Up {ProjectServer} and {SmartProxyServer}].
