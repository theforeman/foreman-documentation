...
[id="enabling-web-ui-access-to-metrics"]
= Enabling web UI access to metrics

[role="_abstract"]
Enable web UI access to metrics by installing Grafana to visualize performance data through interactive dashboards.
...
ifdef::containerized[]
ifndef::orcharhino[]
For more information, see {RHELDocsBaseURL}10/html/monitoring_and_managing_system_status_and_performance/setting-up-graphical-representation-of-pcp-metrics_monitoring-and-managing-system-status-and-performance#configuring-pcp-redis_setting-up-graphical-representation-of-pcp-metrics[Configuring PCP Redis] in _{RHEL}{nbsp}10 Monitoring and managing system status and performance_.
endif::[]
endif::[]
...
ifdef::containerized[]
ifndef::orcharhino[]
For more information, see {RHELDocsBaseURL}10/html/monitoring_and_managing_system_status_and_performance/setting-up-graphical-representation-of-pcp-metrics_monitoring-and-managing-system-status-and-performance#accessing-the-grafana-web-ui_setting-up-graphical-representation-of-pcp-metrics[Accessing the Grafana web UI] in _{RHEL}{nbsp}10 Monitoring and managing system status and performance_.
endif::[]
endif::[]
ifdef::containerized[]
ifdef::katello[]
