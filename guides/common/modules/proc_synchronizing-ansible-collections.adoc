...
.Prerequisites
* To sync Ansible collections from Red Hat Private Automation Hub, you have obtained an authentication token from https://console.redhat.com/ansible/automation-hub/token[Connect to Hub > Load Token].
* To sync Ansible collections from `console.redhat.com`, you have obtained an authentication token and the SSO URL from https://console.redhat.com/ansible/automation-hub/token[Connect to Hub > Load Token].
...
.. To sync Ansible collections from `console.redhat.com`, enter your token in the *Auth Token* field and enter your SSO URL in the *Auth URL* field.
