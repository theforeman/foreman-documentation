...
[role="_abstract"]
Configure NFS shares for content storage to provide scalable storage capacity for {ProjectServer} repositories.
NFS storage enables flexible disk space management for content-intensive deployments.
