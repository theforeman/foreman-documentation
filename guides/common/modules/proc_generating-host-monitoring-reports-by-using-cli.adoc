...
[role="_abstract"]
You can generate host monitoring reports by using Hammer CLI so that you can view host data, such as installed products or compliance status, in a report template.
