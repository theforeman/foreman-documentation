...
For information about migrating from {keycloak-wildfly} to {keycloak-quarkus}, see link:https://docs.redhat.com/en/products/red_hat_build_of_keycloak/26.0[documentation for {keycloak-quarkus}].
====
endif::[]
...
ifndef::orcharhino[]
For more information about importing or creating users, see the https://docs.redhat.com/en/products/red_hat_single_sign-on/7.6/html/server_administration_guide/assembly-managing-users_server_administration_guide#proc-creating-user_server_administration_guide[_{RHSSO} Server Administration Guide_].
endif::[]
