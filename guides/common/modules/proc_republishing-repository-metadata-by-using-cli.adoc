...
[role="_abstract"]
Republish repository metadata when published packages do not match repository contents.

[WARNING]
====
{Team} recommends a complete repository sync or publishing a new content view version to repair broken metadata in favor of republishing repositoriy metadata.
====
