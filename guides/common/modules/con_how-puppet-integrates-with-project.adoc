...
[role="_abstract"]
As a configuration management tool, Puppet uses a server-agent architecture.
{Project} components integrate with Puppet architecture to provide configuration management capabilities in {Project} host inventory.
