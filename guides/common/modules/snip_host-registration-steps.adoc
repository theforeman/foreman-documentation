...
For more information, see xref:common/modules/proc_setting-the-load-balancer-for-host-registration.adoc#Setting_the_Load_Balancer_for_Host_Registration_{context}[].
endif::[]
