...
[role="_abstract"]
These guidelines help you structure products and content views, serve file repositories over HTTP, automate bulk creation, and keep uploads separate from synchronized upstream repositories.
...
+
For more information, see xref:managing-custom-file-type-content[].
endif::[]
