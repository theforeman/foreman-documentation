...
[id="configuring-project-to-use-ldap"]
...
Optional: In the *CA certificate* field, paste one or more PEM-encoded CA certificates to verify the LDAP server's TLS certificate.
