...
+
* If you did not select *Automatically Create Accounts In {Project}* checkbox, see link:{AdministeringDocURL}Creating_a_User_admin[Creating a user] to create user accounts manually.
+
...
See link:{AdministeringDocURL}Assigning_Roles_to_a_User_admin[Assigning Roles to a User] to assign user accounts appropriate roles in {Project}.
