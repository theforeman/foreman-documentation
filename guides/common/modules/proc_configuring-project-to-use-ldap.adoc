...
If you leave this field blank, {Project} uses the system trust store.
If you set a CA certificate, only the configured certificates are trusted and the system trust store is not consulted.
endif::[]
