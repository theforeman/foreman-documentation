...
ifndef::satellite[]
* If you did not select *Automatically Create Accounts In {Project}* checkbox, see {AdministeringDocURL}Creating_a_User_admin[Creating a user] to create user accounts manually.
endif::[]
