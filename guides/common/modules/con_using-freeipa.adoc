...
ifndef::orcharhino[]
However, if you have administrator privileges for both servers, you can configure {FreeIPA} as described in {RHELDocsBaseURL}9/html-single/installing_identity_management/index[Installing Identity Management] for _{RHEL}{nbsp}9_.
See {RHELDocsBaseURL}8/html-single/installing_identity_management/index[Installing Identity Management Guide] for _{RHEL}{nbsp}8_.
endif::[]
