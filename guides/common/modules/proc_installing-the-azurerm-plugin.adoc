...
ifdef::orcharhino[]
For more information on how to install this plug-in, see xref:sources/compute_resources/azure.adoc#installing_azure[Installing Azure] in the _Microsoft Azure Guide_.
endif::[]
