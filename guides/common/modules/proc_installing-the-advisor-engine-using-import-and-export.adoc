[id="installing-the-advisor-engine-using-import-and-export"]
= Installing the advisor engine using import and export

You can transfer the advisor engine container image from a connected system to a disconnected {ProjectServer}. 
