...
ifdef::katello[]
| `{Project} Client` | `https://oss.atix.de/Ubuntu26LTS/` | `stable` | `main` | `amd64`
endif::[]
ifdef::orcharhino[]
| `{Project} Client` | see {atix-kb-clients} in the _ATIX Service Portal_ | `stable` | `main` | `amd64`
endif::[]
|===
...
ifdef::katello[]
| `{Project} Client` | `https://oss.atix.de/Ubuntu24LTS/` | `stable` | `main` | `amd64`
endif::[]
ifdef::orcharhino[]
| `{Project} Client` | see {atix-kb-clients} in the _ATIX Service Portal_ | `stable` | `main` | `amd64`
endif::[]
...
ifdef::katello[]
| `{Project} Client` | `https://oss.atix.de/Ubuntu22LTS/` | `stable` | `main` | `amd64`
endif::[]
ifdef::orcharhino[]
| `{Project} Client` | see {atix-kb-clients} in the _ATIX Service Portal_ | `stable` | `main` | `amd64`
endif::[]
...
ifdef::katello[]
| `{Project} Client` | `https://oss.atix.de/Ubuntu20LTS/` | `stable` | `main` | `amd64`
endif::[]
ifdef::orcharhino[]
| `{Project} Client` | see {atix-kb-clients} in the _ATIX Service Portal_ | `stable` | `main` | `amd64`
endif::[]
