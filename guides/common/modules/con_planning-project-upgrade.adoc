...
[IMPORTANT]
====
If you use Flatpak content in your environment, be aware that upgrading to {Project} {ProjectVersion}.5 will prevent your hosts from consuming Flatpak content from {Project}.
