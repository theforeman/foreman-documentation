...
[id="content-flow-in-{project-context}"]
= Content flow in {Project}
...
ifdef::planning[]
* xref:major-{project-context}-components[]
* {ContentManagementDocURL}[_{ContentManagementDocTitle}_]
endif::[]
ifndef::planning[]
ifdef::satellite[]
* xref:getting-started-with-content-management[]
* xref:manage-software-content-lifecycles[]
endif::[]
endif::[]
