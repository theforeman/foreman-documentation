...
[role="_abstract"]
Content flow in {ProjectName} involves management and distribution of content from external sources to hosts. Content in {Project} flows from _external content sources_ to _{ProjectServer}_.
...
ifdef::satellite[]
* {ContentManagementDocURL}Managing_Red_Hat_Subscriptions_content-management[Managing Red{nbsp}Hat subscriptions in _{ContentManagementDocTitle}_]
endif::[]
