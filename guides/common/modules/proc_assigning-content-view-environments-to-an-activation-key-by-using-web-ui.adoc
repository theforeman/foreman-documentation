...
[role="_abstract"]
Assign content view environments to an activation key to provide hosts with access to content from each assigned environment.
Assigned environments determine which repositories and package versions are available to registered hosts.
