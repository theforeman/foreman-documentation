...
= Overview of the {foreman-installer} utility

[role="_abstract"]
The {foreman-installer} utility is a collection of Puppet modules.
When using {foreman-installer} to manage your configuration, you can preview changes before applying them and restore previous files if needed, which helps prevent overwriting manual configuration changes.
