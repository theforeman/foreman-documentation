...
* On the *Content Hosts* tab, you can install installable errata on selected hosts as described in {ManagingHostsDocURL}patching-hosts-through-errata[Patching hosts through errata] in _{ManagingHostsDocTitle}_.
