...
* On the *Content Hosts* tab, you can apply the erratum to selected hosts as described in {ManagingHostsDocURL}applying-errata-to-hosts[Applying errata to hosts] in _{ManagingHostsDocTitle}_.
