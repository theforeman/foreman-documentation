...
To use the CLI instead of the {ProjectWebUI}, see the xref:common/modules/proc_uploading-additional-scap-content.adoc#cli-Uploading_Additional_SCAP_Content_{context}[CLI procedure].
...
.Verification
* xref:common/modules/proc_listing-available-scap-contents.adoc#listing-available-scap-contents_{context}[List the available SCAP contents].
