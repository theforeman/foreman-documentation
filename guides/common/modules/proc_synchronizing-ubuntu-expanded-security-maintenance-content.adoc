...
[role="_abstract"]
Synchronize Ubuntu Expanded Security Maintenance (ESM) repositories to provide extended security updates for Ubuntu 14.04 and 16.04 hosts.
ESM synchronization requires valid Canonical subscription licenses.
