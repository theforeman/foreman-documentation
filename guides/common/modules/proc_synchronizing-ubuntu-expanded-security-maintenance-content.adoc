...
For repository fields, authentication, and GPG handling, see xref:repository-definitions-for-ubuntu-under-expanded-security-maintenance[].
...
+
Follow xref:repository-definitions-for-ubuntu-under-expanded-security-maintenance[] to obtain an ASCII-armored key if needed.
...
ifdef::orcharhino[]
... Enter *Errata URL* as described in xref:repository-definitions-for-ubuntu-under-expanded-security-maintenance[].
endif::[]
