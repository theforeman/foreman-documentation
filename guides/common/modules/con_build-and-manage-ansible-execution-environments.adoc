...
Ansible Execution Environments are OCI-based container images built by {Project} based on specific base container images and include a specific version of Ansible.
