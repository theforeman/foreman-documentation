...
[role="_abstract"]
If you prefer to install and configure the OpenVox agent on a {Project} host during the registration process, enable the OpenVox agent with host parameters in global parameters or a host group.
