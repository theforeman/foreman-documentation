...
. In the {ProjectWebUI}, navigate to *Hosts* > *Provisioning Setup* > *Installation Media* and create an installation medium.
Set the *Path* to the extracted ISO image on your {SmartProxyServer}.
. In the {ProjectWebUI}, navigate to *Hosts* > *Provisioning Setup* > *Operating Systems* and assign the installation medium to your operating system entry for Ubuntu 22.04.
