...
In the {ProjectWebUI}, navigate to *Infrastructure*{nbsp}>{nbsp}*Subnets*, select a subnet, click the {SmartProxies} tab, and select the *Discovery Proxy* that you want to use.
