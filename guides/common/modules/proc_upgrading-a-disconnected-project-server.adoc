...
. If you use {insights-iop} in your environment, update to the latest images.

.. You can use the {Project} installation ISO image to update the {insights-iop} container content.

.. You can update {insights-iop} by transferring the latest image from a connected system to a disconnected {ProjectServer}.
endif::[]
