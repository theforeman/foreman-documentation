...
... Use the ISO image to set up containers on your {ProjectServer}:
+
[options="nowrap", subs="+quotes,verbatim,attributes"]
----
...
.. Alternatively, you can update {advisorengine} by transferring the latest image from a connected system to a disconnected {ProjectServer}.
