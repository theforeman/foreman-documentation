...
For more information, see {ContentManagementDocURL}Exporting_a_Repository_in_a_Syncable_Format_[Exporting a repository in a syncable format] in _{ContentManagementDocTitle}_.
