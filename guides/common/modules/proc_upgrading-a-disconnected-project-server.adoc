...
.. You can use the {Project} installation ISO image to update the {Insights} container content.

.. You can update {Insights} by transferring the latest image from a connected system to a disconnected {ProjectServer}.
endif::[]
