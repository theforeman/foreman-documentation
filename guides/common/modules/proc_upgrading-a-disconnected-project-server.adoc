...
gpgcheck=0
cost=500
baseurl=file:///<export location>/content/dist/layered/rhel9/x86_64/{project-context}/{ProjectVersion}/os/
----
+
...
--gpgcheck=0 \
--cost=500 \
--baseurl=file:///_Export_Location_/content/dist/layered/rhel8/x86_64/{project-context}/{ProjectVersion}/os/
----
