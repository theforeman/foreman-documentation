...
[role="_abstract"]
The provisioning settings define how {Project} provisions new hosts, including default passwords, template rendering, PXE boot configuration, hostname generation, and virtual machine management.
