...
NOTE: The following chapter describes Red Hat content management provided by Katello plug-in.
Deployments without the plug-in use Installation Media to fetch content from remote or local mirrors.
endif::[]
