...
ifndef::foremanctl[]
For more information, see {IntegratingProvisioningDocURL}configuring-for-uefi-http-boot-provisioning-in-an-ipv6-network_{context}[Configuring {Project} for UEFI HTTP boot provisioning in an IPv6 network] in _{IntegratingProvisioningDocTitle}_.
endif::[]
