...
The communication between {ProjectServer} and managed hosts registered to a {SmartProxyServer} is routed through that {SmartProxyServer}.
{SmartProxyServer} can also provide {Project} services to managed hosts.
