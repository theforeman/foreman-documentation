...
* You have root access to your {ProjectServer}.
...
----
# journalctl --unit _My_Service_
----
* To follow log output in real time, add the `--follow` flag:
+
[options="nowrap", subs="+quotes,verbatim,attributes"]
----
# journalctl --follow --unit _My_Service_
----
+
For example:
+
...
[options="nowrap", subs="+quotes,verbatim,attributes"]
----
# journalctl --grep _My_Correlation_ID_
----
+
For example:
+
...
[options="nowrap", subs="+quotes,verbatim,attributes"]
----
# journalctl --unit _My_Service_ -n 5
----

ifdef::satellite[]
.Additional resources
* {RHELDocsBaseURL}10/html-single/configuring_basic_system_settings/index#viewing-logs-using-the-command-line_assembly_troubleshooting-problems-using-log-files[Viewing logs using the command line in _{RHEL}{nbsp}10 Configuring basic system settings_]
endif::[]
