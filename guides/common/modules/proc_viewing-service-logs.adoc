...
----
# journalctl -u _<service_name>_
----
* To follow log output in real time, add the `-f` flag:
+
[options="nowrap", subs="+quotes,verbatim,attributes"]
----
# journalctl -f -u _<service_name>_
----
+
For example:
+
...
Aug 10 07:19:29 quadlet.example.com foreman[1632]: 2026-08-10T07:19:29 [I|app|eb515c9c] Started GET "/api/v2/ping" for 192.168.124.1
Aug 10 07:19:29 quadlet.example.com foreman[1632]: 2026-08-10T07:19:29 [I|app|eb515c9c] Processing by Api::V2::PingController#ping as JSON
Aug 10 07:19:29 quadlet.example.com pulp-api[1193]: pulp [eb515c9c-cb85-44fa-bd6e-c49eaab71bc5]: "GET /pulp/api/v3/status/ HTTP/1.1" 200 6250
Aug 10 07:19:29 quadlet.example.com foreman[1632]: 2026-08-10T07:19:29 [I|app|eb515c9c] Completed 200 OK in 186ms (Views: 12.8ms | ActiveRecord: 8.1ms | Allocations: 42460)
----
...
[options="nowrap", subs="+quotes,verbatim,attributes"]
----
# journalctl -u _<service_name>_ -n 5
----
