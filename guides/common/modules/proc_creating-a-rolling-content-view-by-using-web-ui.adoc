...
* To register a host to your rolling content view, see {ManagingHostsDocURL}registering-hosts-to-project_managing-hosts[Registering hosts to {Project}] in _{ManagingHostsDocTitle}_.
