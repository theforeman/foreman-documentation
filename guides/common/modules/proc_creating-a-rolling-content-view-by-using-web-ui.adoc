...
For more information, see xref:creating-an-activation-key-by-using-web-ui[].
* To register a host to your rolling content view, see {ManagingHostsDocURL}registering-hosts-and-setting-up-host-integration_managing-hosts[Registering hosts] in _{ManagingHostsDocTitle}_.
