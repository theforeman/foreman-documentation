...
[role="_abstract"]
Create an incremental content view version using Hammer CLI to make non-installable errata available to your hosts without republishing the entire content view.
