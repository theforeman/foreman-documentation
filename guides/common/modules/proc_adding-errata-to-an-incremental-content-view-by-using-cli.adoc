...
[role="_abstract"]
If errata are available but not installable, you can create an incremental content view version by using Hammer CLI to add the errata to your content hosts.
