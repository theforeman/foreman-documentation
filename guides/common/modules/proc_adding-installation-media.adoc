...
You can view installation media by navigating to *Hosts*{nbsp}>{nbsp}*Installation Media* menu.
...
.Procedure
. In the {ProjectWebUI}, navigate to *Hosts*{nbsp}>{nbsp}*Installation Media* and click *Create Medium*.
