...
[id="metrics-solution-components"]
= Metrics solution components

[role="_abstract"]
The metrics monitoring solution uses multiple components to collect, store, and visualize {Project} performance data for analysis and troubleshooting.
...
A Performance Metric Domain Agent is a PCP add-on that enables access to metrics of an application or service.
