...
[role="_abstract"]
When you register a host with multiple activation keys, {Project} merges their settings and resolves conflicts by key order and the *Allow multiple content views* setting.
