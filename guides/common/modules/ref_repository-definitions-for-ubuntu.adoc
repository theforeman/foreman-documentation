...
[role="_abstract"]
Upstream repositories for Ubuntu include *main*, *updates*, and *security* repositories under Standard Security Maintenance, and the optional {project-client-name} repository, for supported LTS releases.
