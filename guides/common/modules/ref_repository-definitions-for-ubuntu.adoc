...
[role="_abstract"]
Use these example names, URLs, releases, components, and architectures when you synchronize Ubuntu main, updates, security under Standard Security Maintenance, plus {project-client-name} for supported LTS releases.
