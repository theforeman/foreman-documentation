...
[id="{smart-proxy-context}-performance-tests"]
...
You can choose the right resources based on your expected workload for content delivery, host registration, and remote execution tasks.
