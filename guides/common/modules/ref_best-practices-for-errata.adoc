...
* Check the host details page to compare errata between the current content view environments and the Library lifecycle environment, which contains the latest synchronized packages.
+
