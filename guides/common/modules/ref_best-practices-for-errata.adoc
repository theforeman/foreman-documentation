...
[role="_abstract"]
Apply errata to add security patches and bug fixes without updating unaffected packages in frozen content.
Errata best practices enable targeted patching and automated update management.
