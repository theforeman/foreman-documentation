...
+
Note that a manifest exported from the {RHCloud} does not yet contain any subscriptions.
After you import the manifest into {Project}, add subscriptions to the manifest.
