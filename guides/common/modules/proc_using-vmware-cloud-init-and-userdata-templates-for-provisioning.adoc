...
.Prerequisites
* Associate the templates with your operating system. For more information, see xref:associating-the-userdata-and-cloud-init-templates-with-the-operating-system_{context}[].
