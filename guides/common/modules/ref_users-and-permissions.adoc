...
[role="_abstract"]
Use Hammer CLI commands to manage users, user groups, roles, and filters in {ProjectName}.
Control access and permissions within your {Project} by using these commands.
