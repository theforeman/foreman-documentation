...
ifdef::katello[]
| `{Project} Client` | `https://oss.atix.de/Debian13/` | `stable` | `main` | `amd64`
endif::[]
ifdef::orcharhino[]
...
ifdef::katello[]
| `{Project} Client` | `https://oss.atix.de/Debian12/` | `stable` | `main` | `amd64`
endif::[]
ifdef::orcharhino[]
| `{Project} Client` | see {atix-kb-clients} in the _ATIX Service Portal_ | `stable` | `main` | `amd64`
endif::[]
...
ifdef::katello[]
| `{Project} Client` | `https://oss.atix.de/Debian11/` | `stable` | `main` | `amd64`
endif::[]
ifdef::orcharhino[]
| `{Project} Client` | see {atix-kb-clients} in the _ATIX Service Portal_ | `stable` | `main` | `amd64`
endif::[]
