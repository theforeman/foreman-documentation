...
[role="_abstract"]
Synchronize content from upstream repositories to mirror packages and updates for distribution to your hosts.
Repository synchronization ensures your hosts have access to the latest available content.
