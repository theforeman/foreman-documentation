...
For more information about adding repositories, see {ContentManagementDocURL}synchronizing-repositories-on-demand[Synchronizing repositories on demand] in _{ContentManagementDocTitle}_.
