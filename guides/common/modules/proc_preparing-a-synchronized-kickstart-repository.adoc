...
For more information about adding repositories, see {ContentManagementDocURL}repository-synchronization[Repository synchronization] in _{ContentManagementDocTitle}_.
