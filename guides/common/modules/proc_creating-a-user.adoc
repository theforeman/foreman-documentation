...
** *EXTERNAL*: to configure external authentication as described in link:{InstallingServerDocURL}Configuring_External_Authentication_{project-context}[Configuring external authentication].
