...
[id="exporting-a-content-view-version-incrementally"]
...
Content view versions that have multiple {client-os} trees can occupy several gigabytes of space on {ProjectServer}.
