...
An additional SCC account should only be added for the purpose of switching SCC accounts.

If you need to use additional SCC accounts, you need to add them to other organizations.
====
