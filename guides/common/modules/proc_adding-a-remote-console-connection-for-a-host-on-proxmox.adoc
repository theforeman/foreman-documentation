...
.Prerequisites
* Your {ProjectServer} has opened the ports for the VNC connection.
...
* {InstallingServerDocURL}{project-context}-port-and-firewall-requirements[{ProjectServer} port and firewall requirements in _{InstallingServerDocTitle}_]
