...
* `--bmc-id xref:hammer-option-details-number[NUMBER]` {endash} BMC Capsule ID to use within this subnet
...
* `--dhcp-id xref:hammer-option-details-number[NUMBER]` {endash} DHCP Capsule ID to use within this subnet
* `--discovery-id xref:hammer-option-details-number[NUMBER]` {endash} ID of Discovery Capsule to use within this subnet for managing connection to
discovered hosts
* `--dns xref:hammer-option-details-value[VALUE]` {endash} DNS Proxy to use within this subnet
* `--dns-id xref:hammer-option-details-number[NUMBER]` {endash} DNS Capsule ID to use within this subnet
...
* `--externalipam-id xref:hammer-option-details-number[NUMBER]` {endash} External IPAM Capsule ID to use within this subnet
...
* `--httpboot-id xref:hammer-option-details-number[NUMBER]` {endash} HTTPBoot Capsule ID to use within this subnet
...
* `--remote-execution-proxy-ids xref:hammer-option-details-list[LIST]` List of Capsule IDs to be used for remote execution
* `--template-id xref:hammer-option-details-number[NUMBER]` {endash} Template HTTP(S) Capsule ID to use within this subnet
* `--tftp xref:hammer-option-details-value[VALUE]` {endash} TFTP Proxy to use within this subnet
* `--tftp-id xref:hammer-option-details-number[NUMBER]` {endash} TFTP Capsule ID to use within this subnet
