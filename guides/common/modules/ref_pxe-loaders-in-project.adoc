...
[id="pxe-loaders-in-project"]
= PXE loaders in {Project}

[role="_abstract"]
A PXE loader defines the `filename` DHCPv4 option to use during provisioning.
The required files are deployed to TFTP {SmartProxy}.
