...
[role="_abstract"]
You can monitor and manage all planned or performed tasks, such as repositories synchronized, errata applied, and content views published, to track progress, troubleshoot issues, or adjust timeout settings for low bandwidth or high latency environments.
