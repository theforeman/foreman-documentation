...
[id="{project-context}-task-management"]
= {Project} task management

[role="_abstract"]
You can monitor and manage all planned or performed tasks, such as repositories synchronized, errata applied, and content views published.
This is useful to track progress, troubleshoot issues, or adjust timeout settings for low bandwidth or high latency environments.

Reviewing the log::
To review the log, in the {ProjectWebUI}, navigate to *Monitor* > *{Project} Tasks* > *Tasks*.
+
