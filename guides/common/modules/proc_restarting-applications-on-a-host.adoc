...
[role="_abstract"]
You can restart applications on a host from the {ProjectWebUI} when the host reports pending restarts, for example after package updates.
{Project} uses remote execution to restart applications on the host.
