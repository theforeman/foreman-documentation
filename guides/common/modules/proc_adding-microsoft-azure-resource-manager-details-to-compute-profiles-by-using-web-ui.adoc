...
[id="adding-microsoft-azure-resource-manager-details-to-compute-profiles-by-using-web-ui"]
= Adding Microsoft Azure Resource Manager details to compute profiles by using {ProjectWebUI}
