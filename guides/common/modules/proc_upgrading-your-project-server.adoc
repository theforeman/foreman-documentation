...
Upgrading a connected {ProjectServer} includes backing up the server, ensuring that the system and {Project} configuration is up-to-date, and running the upgrade.
