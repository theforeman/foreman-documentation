...
image::planning-for-foreman-lifecycle-path-basic.svg[A single lifecycle environment]
endif::[]
ifdef::orcharhino[]
image::planning-for-foreman-lifecycle-path-basic-orcharhino.svg[A single lifecycle environment]
endif::[]
ifdef::satellite[]
...
+
ifdef::foreman-el,foreman-deb,katello[]
image::planning-for-foreman-lifecycle-path-simple.svg[A single lifecycle environment path]
endif::[]
ifdef::orcharhino[]
image::planning-for-foreman-lifecycle-path-simple-orcharhino.svg[A single lifecycle environment path]
endif::[]
ifdef::satellite[]
...
+
ifdef::foreman-el,foreman-deb,katello[]
image::planning-for-foreman-lifecycle-path-diverged.svg[Application specific lifecycle environment paths]
endif::[]
ifdef::orcharhino[]
image::planning-for-foreman-lifecycle-path-diverged-orcharhino.svg[Application specific lifecycle environment paths]
endif::[]
ifdef::satellite[]
