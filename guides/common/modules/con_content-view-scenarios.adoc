...
image::common/lifecycle-path-basic.svg[A single lifecycle environment]
endif::[]
ifdef::orcharhino[]
// TODO: Add image
endif::[]
...
+
ifdef::foreman-el,foreman-deb,katello[]
image::common/lifecycle-path-simple.svg[A single lifecycle environment path]
endif::[]
ifdef::orcharhino[]
// TODO: Add image
endif::[]
...
+
ifdef::foreman-el,foreman-deb,katello[]
image::common/lifecycle-path-diverged.svg[Application specific lifecycle environment paths]
endif::[]
ifdef::orcharhino[]
// TODO: Add image
endif::[]
