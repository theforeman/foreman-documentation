...
If the pre-upgrade check discovers permission issues, you must identify and remedy the issues before proceeding with the upgrade.
...
If you see this error on your {ProjectServer}, identify and remedy the permission issues.
