...
For more information, see {InstallingServerDocURL}preparing-your-environment-for-{project-context}-server-installation[Preparing your environment for {ProjectServer} installation].
