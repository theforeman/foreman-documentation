...
For more information, see {AdministeringDocURL}installing-postgresql-as-an-external-database[Installing PostgreSQL as an external database] in _{AdministeringDocTitle}_.
