...
* Flatpak is set up on the host that consumes applications from {ProjectServer}.
...
* To install Flatpak applications from {Project}, your {Project} account has the `view_lifecycle_environments`, `view_products`, and `view_content_views` permissions, unless the lifecycle environment allows unauthenticated pull.
