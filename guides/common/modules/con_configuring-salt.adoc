...
[NOTE]
====
If you select Salt during the xref:orcharhino_Installer_GUI[main orcharhino installation steps], the installer automatically performs those steps on your {Project}.
