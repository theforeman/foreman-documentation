...
* Optional: If you want to use Puppet with Azure hosts, navigate to *Administer*{nbsp}>{nbsp}*Settings* > *Puppet* and enable the `Use UUID for certificates` setting to configure Puppet to use consistent Puppet certificate IDs.
