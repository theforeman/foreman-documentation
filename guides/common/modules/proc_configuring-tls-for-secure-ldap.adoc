...
* link:https://docs.redhat.com/en/products/red_hat_enterprise_linux/9/html/securing_networks/using-shared-system-certificates_securing-networks[Using shared system certificates in _{RHEL}{nbsp}9 Securing networks_]
endif::[]
