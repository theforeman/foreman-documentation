...
Job templates, depending on the implementation and category, will either enable the `bootc usr-overlay` or pass the `--transient` flag to ensure that packages are installed correctly.
