...
[role="_abstract"]
You can create at least one {SmartProxyServer} per geographic location to save bandwidth by having hosts obtain content locally.
Only the {SmartProxy} synchronizes content from remote repositories, making your provisioning infrastructure more reliable and easier to configure.
