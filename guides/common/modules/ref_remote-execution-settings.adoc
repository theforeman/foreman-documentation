...
[role="_abstract"]
The remote execution settings define how {Project} executes commands and scripts on remote hosts, including SSH configuration, user management, proxy selection, and job template synchronization.
