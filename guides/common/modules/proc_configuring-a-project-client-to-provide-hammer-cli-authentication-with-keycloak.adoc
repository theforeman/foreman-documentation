...
ifeval::["{context}" == "keycloak-quarkus"]
* If you initialized your Keycloak server without the `--http-relative-path=/auth` context path, obtain the values to configure {Project} settings from the following URL: `https://_{keycloak-example-com}_/realms/_{Project}_Realm_/.well-known/openid-configuration`.
Replace _{Project}_Realm_ with the name of the {keycloak} realm created for your {Project} server.
* If you initialized your Keycloak server with the `--http-relative-path=/auth` context path, obtain the values to configure {Project} settings from the following URL: `https://_{keycloak-example-com}_/auth/realms/_{Project}_Realm_/.well-known/openid-configuration`.
Replace _{Project}_Realm_ with the name of the {keycloak} realm created for your {Project} server.
endif::[]
ifeval::["{context}" == "keycloak-wildfly"]
...
--value "https://_{keycloak-example-com}_/realms/_{keycloak-realm}_"
----
+
...
--value "https://_{keycloak-example-com}_/realms/_{keycloak-realm}_/protocol/openid-connect/certs"
----
+
* If you initialized your Keycloak server with the `--http-relative-path=/auth` context path:
+
