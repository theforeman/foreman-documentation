...
----
$ hammer settings set --name oidc_issuer \
--value "https://_{keycloak-example-com}_:8443/auth/realms/_{keycloak-realm}_"
----
endif::[]
ifeval::["{context}" == "keycloak-wildfly"]
[options="nowrap", subs="+quotes,attributes"]
...
----
$ hammer settings set --name oidc_jwks_url \
--value "https://_{keycloak-example-com}_:8443/auth/realms/_{keycloak-realm}_/protocol/openid-connect/certs"
----
endif::[]
ifeval::["{context}" == "keycloak-wildfly"]
[options="nowrap", subs="+quotes,attributes"]
