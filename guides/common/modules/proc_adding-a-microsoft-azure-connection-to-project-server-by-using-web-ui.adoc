...
[id="adding-a-microsoft-azure-connection-to-{project-context}-server-by-using-web-ui"]
= Adding a Microsoft Azure connection to {ProjectServer} by using {ProjectWebUI}
