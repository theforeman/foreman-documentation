...
ifdef::azure-provisioning[. In the *Image* field, you can select the Azure Resource Manager image, including any custom or shared image gallery image created.]
