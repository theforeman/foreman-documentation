[id="Tailoring_Files_{context}"]
= Tailoring Files

Tailoring Files allow existing OpenSCAP policies to be customized without forking or rewriting the policy.
You can assign a Tailoring File to a policy when creating or updating a policy.

You can create a Tailoring File using the https://www.open-scap.org/tools/[SCAP Workbench].
