...
[role="_abstract"]
Verify checksums on a {SmartProxyServer} for a repository, content view, lifecycle environment, or all {SmartProxyServer} content when hosts cannot consume synchronized packages.
