...
[role="_abstract"]
Verify checksums on your {SmartProxyServer} for a repository, content view, lifecycle environment, or all {SmartProxyServer} content when hosts cannot consume synchronized packages.

.Prerequisites
* The lifecycle environment, content view, or repository that you want to repair is available on the {SmartProxyServer}.
