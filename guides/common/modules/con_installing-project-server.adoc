...
ifdef::foremanctl[]
:DeploymentType: as a containerized deployment{blank}
endif::[]
ifndef::foremanctl[]
...
Use the following procedures to install {ProjectServer} {DeploymentType} in a connected environment, perform the initial configuration, and import subscription manifests.
...
Use the following procedures to install {ProjectServer} {DeploymentType} in a disconnected environment, perform the initial configuration, and import subscription manifests.
...
ifndef::satellite[]
Use the following procedures to install {ProjectServer} {DeploymentType} and perform the initial configuration.
endif::[]
