...
[id="adding-a-subnet-to-{project-context}-server-by-using-web-ui"]
...
. In the Subnets window, click *Create Subnet*.
...
For more information about IPAM, see xref:resources-for-network-based-provisioning[].
+
