...
= Configuring group mapping for {keycloak-wildfly} authentication
...
As a result, anyone in the given group in {keycloak-wildfly} are logged in under the corresponding {Project} group.
