...
ifdef::satellite[]
If you want to delete all OpenSCAP reports, use the script in the {HammerGuideURL}/chap-red_hat_satellite-api_guide-using_the_red_hat_satellite_api#sect-API_Guide-Deleting-OpenSCAP-Reports[Deleting OpenSCAP Reports] section of the _{APIGuideTitle}_.
endif::[]
