...
You can upgrade from any minor version of {SmartProxyServer} {ProjectVersionPrevious} to {ProjectVersion}.

.Prerequisites
ifdef::katello,orcharhino,satellite[]
* If you use content views to control updates to the base operating system of {SmartProxyServer}, or for {SmartProxyServer} repository, update those content views with new repositories, publish, and promote their updated versions.
