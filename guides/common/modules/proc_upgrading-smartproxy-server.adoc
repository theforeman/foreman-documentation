...
----
+
. Synchronize the repository in the {ProjectServer}:
** If you have Extended Update Support (EUS), synchronize `{RepoRHEL8EUSServerSatelliteCapsuleProjectVersion}`.
** If you do not have Extended Update Support (EUS), synchronize `{RepoRHEL8ServerSatelliteCapsuleProjectVersion}`.
