...
- If you use custom templates, replace `@host.lifecycle_environment` with `@host.single_lifecycle_environment` and `@host.content_view` with `@host.single_content_view`.
endif::[]
