...
[role="_abstract"]
If you want to revert to the default certificate configuration, you can reset a custom SSL certificate to the default self-signed certificate on your {SmartProxyServer} by re-registering the server.
