...
[id="configuring-a-finish-template-for-amazon-ec2"]
= Configuring a finish template for Amazon EC2
...
----
+
. Click the *Association* tab, and associate the template with a {client-os} operating system that you want to use.
