...
[role="_abstract"]
If you prefer to install and configure the OpenVox agent on a {Project} host during the provisioning process, add the `puppet_setup` snippet to your provisioning template.
