...
For more information, see {ContentManagementDocURL}adding-content-sources-to-{project-context}[Adding content sources to {Project}] in _{ContentManagementDocTitle}_.
