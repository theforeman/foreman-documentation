...
[role="_abstract"]
If you prefer to install and configure the OpenVox agent on a host when provisioning the host through {Project}, add the `puppet_setup` snippet to your provisioning template.
