...
+
For more information, see link:https://docs.redhat.com/en/documentation/red_hat_enterprise_linux/10/html/installing_trust_between_idm_and_ad[{RHEL}{nbsp}10 _Installing trust between IdM and AD_].
endif::[]
endif::[]
