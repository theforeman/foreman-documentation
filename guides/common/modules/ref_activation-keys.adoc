...
[role="_abstract"]
You can to create activation keys and add subscriptions in {ProjectName} by using Hammer CLI commands.
Activation keys automatically configure content access for hosts during registration.
