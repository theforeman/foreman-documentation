...
[id="host-provisioning-settings"]
= Host provisioning settings

[role="_abstract"]
The provisioning settings define how {Project} provisions hosts, including default passwords, template rendering, PXE boot configuration, hostname generation, and virtual machine management.
