...
.Procedure
ifndef::foremanct[]
* To configure the host with the bootstrap script, run the bootstrap script with the `--server _My-Alternate-FQDN.example.com_` option to register the host to the alternate {Project} CNAME:
+
