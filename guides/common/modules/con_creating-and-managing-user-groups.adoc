...
If you use an external authentication source, you can map {Project} user groups to external user groups as described in {ConfiguringUserAuthenticationDocURL}managing-external-user-groups[Managing external user groups] in _{ConfiguringUserAuthenticationDocTitle}_.
