...
ifndef::orcharhino[]
+
See {RHELDocsBaseURL}10/html/installing_identity_management/preparing-the-system-for-idm-server-installation#port-requirements-for-idm[Port requirements for {FreeIPA}] in the _{RHEL}{nbsp}10 Installing Identity Management guide_.
endif::[]
endif::[]
