...
[role="_abstract"]
Create incremental Library exports containing only changed content to reduce export size and save system resources.
Incremental exports are ideal for organizations with multiple operating system trees and large content repositories.
