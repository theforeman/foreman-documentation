...
[role="_abstract"]
The template sync settings define how {Project} synchronizes templates with Git repositories, including import and export behavior, filtering, locking, and metadata handling.
