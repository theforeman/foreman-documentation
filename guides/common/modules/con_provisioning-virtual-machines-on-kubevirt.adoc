...
ifdef::satellite[]
link:https://docs.redhat.com/en/documentation/openshift_container_platform/latest/html/virtualization/about#default-cluster-roles-for-virt_virt-security-policies[Default cluster roles for OpenShift Virtualization].
endif::[]
ifndef::satellite[]
link:https://kubevirt.io/user-guide/cluster_admin/authorization/[Authorization] in the _KubeVirt user guide_.
endif::[]
