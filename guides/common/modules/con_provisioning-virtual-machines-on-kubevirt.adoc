...
ifdef::satellite[]
* link:https://docs.redhat.com/en/products/openshift_container_platform/latest/html/virtualization/about#authorization_virt-security-policies[Authorization for OpenShift Container Platform Virtualization]
endif::[]
ifndef::satellite[]
