...
* For more information about modules and lifecycle streams on {RHEL}{nbsp}8, see https://access.redhat.com/support/policy/updates/rhel-app-streams-life-cycle[{RHEL} Application Streams Lifecycle].
