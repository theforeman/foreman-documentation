...
[role="_abstract"]
Register an external Flatpak index in {ProjectWebUI} as the first step toward scanning it and mirroring selected repositories into your products for host distribution.
