...
[role="_abstract"]
To ensure that VMs deployed from your image are treated as clean and unique instances that can be successfully registered and managed by {Project}, prepare your pre-built Red Hat Enterprise Linux 7 image for cloud or virtual machine deployment and subsequent management by {Project}.
