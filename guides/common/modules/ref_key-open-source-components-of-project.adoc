...
[id="key-open-source-components-of-{project-context}"]
= Key open source components of {Project}
...
* https://access.redhat.com/articles/1343683[Satellite 6 Component Versions]
endif::[]
