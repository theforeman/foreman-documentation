...
[id="planning-organization-and-location-context"]
= Planning organization and location
...
ifdef::satellite[]
* {AdministeringDocURL}managing-organizations-in-{project-context}[Managing organizations in _{AdministeringDocTitle}_]
* {AdministeringDocURL}managing-locations-in-{project-context}[Managing locations in _{AdministeringDocTitle}_]
endif::[]
ifndef::satellite[]
