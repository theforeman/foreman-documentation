...
ifdef::satellite[]
* {AdministeringDocURL}managing-organizations-in-{project-context}_admin[Managing organizations in _{AdministeringDocTitle}_]
* {AdministeringDocURL}managing-locations-in-{project-context}_admin[Managing locations in _{AdministeringDocTitle}_]
endif::[]
ifndef::satellite[]
