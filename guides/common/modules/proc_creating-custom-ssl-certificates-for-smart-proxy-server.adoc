...
countryName =_My_Country_Name_ <3>
stateOrProvinceName = _My_State_Or_Province_Name_ <4>
localityName = _My_Locality_Name_ <5>
organizationName = _My_Organization_Or_Company_Name_
organizationalUnitName = _My_Organizational_Unit_Name_ <6>
----
<3> Two letter code
<4> Full name
<5> Full name (example: New York)
<6> Division responsible for the certificate (example: IT department)
