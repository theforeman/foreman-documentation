...
[role="_abstract"]
To synchronize content over a network, configure your downstream {ProjectServer} to pull repositories from a connected upstream server by using Hammer CLI.
