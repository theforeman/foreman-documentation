...
[id="installing-postgresql-as-an-external-database"]
= Installing PostgreSQL as an external database

[role="_abstract"]
Install and configure PostgreSQL on a dedicated host if you want to use an external database with your {ProjectServer}.
