...
.Prerequisites
* The errata to be installed should be available in one of the existing repositories, or the repository should be enabled on the host before this procedure.
