...
To enable it, in the {ProjectWebUI}, navigate to *Administer*{nbsp}>{nbsp}*Settings*, and on the *Content* tab, set `Prefer registered through {SmartProxy} for remote execution` to *Yes*.
