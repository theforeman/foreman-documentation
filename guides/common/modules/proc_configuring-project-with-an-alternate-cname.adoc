...
----
# {foremanctl-installer} --certificate-cname _My-Alternate-FQDN.example.com_
----
endif::[]
ifndef::foremanctl[]
...
[options="nowrap" subs="+quotes,attributes"]
----
# {foreman-installer} --certs-cname _My-Alternate-FQDN.example.com_ --certs-update-server
----
