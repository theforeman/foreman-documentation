...
----
. If you have not installed {Project}, you can add the `--certs-cname _My-Alternate-FQDN.example.com_` option to the `{foreman-installer}` command to install {Project} with an alternate CNAME.
endif::[]
