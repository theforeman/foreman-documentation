...
When you enable a Red{nbsp}Hat repository, an associated {Project} product is created automatically.
To distribute content from custom sources, you need to create products and repositories manually.
