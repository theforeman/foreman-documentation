...
[id="identifying-available-metrics"]
= Identifying available metrics

[role="_abstract"]
Use these commands to discover what PCP metrics are available on your system, including both system-level metrics and {Project}-specific telemetry data, and to locate archived metric logs for historical analysis.
