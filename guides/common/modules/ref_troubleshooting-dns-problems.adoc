...
:_template-generated: 2025-12-02
:_mod-docs-content-type: REFERENCE

[id="troubleshooting-dns-problems_{context}"]
= Troubleshooting DNS problems

DNS problems might prevent hosts from being provisioned because they cannot correctly resolve the {Project} or {SmartProxyServer} hostnames required to download installation content or configuration files.
