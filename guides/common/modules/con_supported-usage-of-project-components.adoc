...
A Puppet module, running on a OpenVox server on your {ProjectServer} or any {SmartProxyServer}, is also supported by {Team}.

ifdef::satellite[]
.Additional resources
* https://access.redhat.com/articles/369183[How does Red{nbsp}Hat support scripting frameworks in Red{nbsp}Hat Knowledgebase]
* https://access.redhat.com/support/policy/updates/satellite[Red{nbsp}Hat Satellite Product Life Cycle]
endif::[]
