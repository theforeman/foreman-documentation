...
. In the {ProjectWebUI}, navigate to the *Default Behavior* area, and select the *Override* check box.
...
. In the {ProjectWebUI}, navigate to *Hosts* > *All Hosts*, and on the host that you want to use, click the *Edit* button.
