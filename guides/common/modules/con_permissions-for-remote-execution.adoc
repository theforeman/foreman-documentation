...
* *Remote Execution Manager*: Users with this can access all remote execution features and functionality.

* *Remote Execution User*: Users with this role can only run jobs; they do not have permission to modify job templates.
