...
[id="configuring-the-base-operating-system-with-offline-repositories"]
= Configuring the base operating system with offline repositories

[role="_abstract"]
Use this procedure to configure offline repositories for the {RHEL} 9 base operating system.
