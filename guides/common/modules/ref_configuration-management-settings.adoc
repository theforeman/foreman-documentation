...
[role="_abstract"]
The configuration management settings define how {Project} integrates with configuration management tools, including automatic host creation from reports, smart class parameter evaluation, and configuration status tracking.
