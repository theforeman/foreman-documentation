...
{ProjectServer} has to be enrolled in the IdM domain and integrated as described in xref:configuring-a-freeipa-server-as-an-external-identity-provider-for-project_{context}[].
