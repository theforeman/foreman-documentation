...
[role="_abstract"]
The general settings define system-wide configuration options for {Project}, including administrator email, instance URL, user interface preferences, proxy settings, and default language and timezone.
