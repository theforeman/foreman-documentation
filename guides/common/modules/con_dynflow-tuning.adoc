...
Sidekiq workers can be grouped into various queues to ensure many tasks of one type will not block execution of tasks of other type.

{Team} recommends to increase the number of sidekiq workers to scale the Foreman tasking system for bulk concurrent tasks.
