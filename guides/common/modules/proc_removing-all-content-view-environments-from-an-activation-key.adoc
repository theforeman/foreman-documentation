...
[role="_abstract"]
Use Hammer CLI to remove all content view environments from an activation key when you need to clear assignments before reconfiguring registration settings.
