...
For more information, see {ConfiguringUserAuthenticationDocURL}configuring-kerberos-sso-with-{FreeIPA-context}-in-project_{project-context}[Configuring Kerberos SSO with {FreeIPA} in {Project}] in _{ConfiguringUserAuthenticationDocTitle}_.
endif::[]
