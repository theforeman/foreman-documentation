...
Before you can configure provisioning callbacks, you must add {Project} as a dynamic inventory in {awx}. For more information, see xref:integrating-ansible-tower_ansible[Integrating {Project} and {awx}].
