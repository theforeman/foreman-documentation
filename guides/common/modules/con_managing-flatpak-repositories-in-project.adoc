...
In {Project}, you can integrate Flatpak remotes and mirror Flatpak repositories into products to manage application content centrally.
...
* xref:synchronizing-content-between-{project-context}-servers[]
