...
= Adding a default HTTP proxy to {Project} by using Hammer CLI
...
To use the {ProjectWebUI} instead of the CLI, see the xref:adding-a-default-http-proxy-by-using-web-ui[].
