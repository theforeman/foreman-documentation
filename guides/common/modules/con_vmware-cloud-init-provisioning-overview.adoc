...
.VMware cloud-init provisioning overview
ifdef::satellite[]
image::user-data-sequence-satellite.png[VMware cloud-init provisioning overview]
endif::[]
ifdef::orcharhino[]
image::user-data-sequence-orcharhino.svg[VMware cloud-init provisioning overview]
endif::[]
ifndef::satellite,orcharhino[]
image::user-data-sequence-foreman.svg[VMware template provisioning]
endif::[]
