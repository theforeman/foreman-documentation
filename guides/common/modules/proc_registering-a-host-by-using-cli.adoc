...
[role="_abstract"]
You can register a host from the command line by using registration templates and set up various integration features and host tools during the registration process.
