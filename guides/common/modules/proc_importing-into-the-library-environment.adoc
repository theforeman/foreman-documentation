...
[id="importing-into-the-library-environment"]
= Importing into the Library environment

[role="_abstract"]
You can import exported Library content into the Library environment of an organization on a downstream {ProjectServer}.
...
* The user importing the content has the _Content Importer_ role.
