...
[role="_abstract"]
You can create a host group for the Library lifecycle environment and nested host groups for other lifecycle environments.
This organizes hosts by lifecycle stage, for example Development, Testing, and Production.
