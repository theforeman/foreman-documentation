...
[id="preparing-networking-for-host-management"]
= Preparing networking for host management

[role="_abstract"]
You must configure network services on your {SmartProxies} based on the provisioning type.
