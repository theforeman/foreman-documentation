...
[id="uploading-content-smaller-than-2-mb"]
= Uploading content smaller than 2 MB
...
For information about uploading larger content, see xref:uploading-content-larger-than-2-mb[].
