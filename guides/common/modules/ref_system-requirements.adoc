...
The {Project} and {SmartProxy} server do not support shortnames in the hostnames.
Also, the custom certificate's Common Name (CN) must have a fully qualified domain name (FQDN) instead of a shortname.
