...
For more information, see {RHELDocsBaseURL}10/html/configuring_time_synchronization/index[Configuring time synchronization] in _{RHEL}{nbsp}10 Configuring time synchronization_
endif::[]
