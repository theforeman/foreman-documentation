...
For more information, see {RHELDocsBaseURL}8/html/configuring_basic_system_settings/configuring-time-synchronization_configuring-basic-system-settings[Configuring time synchronization] in _{RHEL}{nbsp}8 Configuring basic system settings_.
endif::[]
