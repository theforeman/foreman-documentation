...
[role="_abstract"]
You can use text values and temporal values in your queries, with text values requiring quotes when they contain spaces, and temporal values accepting various date and time formats to filter resources by specific criteria.
