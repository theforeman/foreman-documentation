...
To configure {Project} to use external DHCP, DNS, and TFTP services, see {InstallingProjectDocURL}configuring-external-services[Configuring External Services] in _{InstallingServerDocTitle}_.
