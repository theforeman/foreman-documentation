...
include::snip_upgrading-project-server-prerequisites.adoc[leveloffset=+3]
...
- To upgrade a {ProjectServer} not connected to the Red{nbsp}Hat Content Delivery Network, proceed to xref:upgrading_a_disconnected_{project-context}_server_{context}[].
