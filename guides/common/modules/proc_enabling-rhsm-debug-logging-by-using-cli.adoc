...
= Enabling RHSM debug logging by using the Hammer CLI

[role="_abstract"]
You can enable Red{nbsp}Hat Subscription Manager (RHSM) debug logging for the `/var/log/rhsm/rhsm.log` file by using the Hammer CLI tool.
