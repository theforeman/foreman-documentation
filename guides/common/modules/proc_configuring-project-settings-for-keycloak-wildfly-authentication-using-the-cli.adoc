...
Use this procedure to configure {Project} settings for {keycloak-wildfly} authentication using the {Project} CLI.
...
. Set the algorithm for encoding on {keycloak-wildfly}, for example, `RS256`:
+
----
