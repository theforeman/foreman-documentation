...
= Creating a custom SSL certificate for {parent-ProductName}

ifeval::["{context}" == "{project-context}"]
Use this procedure to create a custom SSL certificate for {parent-ProductName}.
If you already have a custom SSL certificate for {parent-ProductName}, skip this procedure.
endif::[]

ifeval::["{context}" == "{smart-proxy-context}"]
On {ProjectServer}, create a custom certificate for your {parent-ProductName}.
If you already have a custom SSL certificate for {parent-ProductName}, skip this procedure.
endif::[]
...
+
If you already have a private key for this {parent-ProductName}, skip this step.
+
[options="nowrap", subs="+quotes,attributes"]
----
