...
[role="_abstract"]
ifdef::satellite[]
You can manage the software lifecycle for your {RHEL} systems by organizing various types of content.
endif::[]
ifndef::satellite[]
You can manage the software lifecycle for your systems by organizing various types of content.
endif::[]
Manage base operating systems, middleware services, and end-user applications to maintain reliable and up-to-date host environments.
