...
[id="preconfigured-rhel-kvm-guest-images"]
= Preconfigured {RHEL} KVM guest images

[role="_abstract"]
You can use preconfigured {RHEL} KVM guest QCOW2 images to provision cloud instances.

Select a preconfigured {RHEL} KVM guest QCOW2 image:
