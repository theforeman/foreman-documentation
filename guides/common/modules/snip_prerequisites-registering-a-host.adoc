...
For more information, see {ConfiguringLoadBalancerDocURL}configuring-a-host-for-registration[Configuring a host for registration] in _{ConfiguringLoadBalancerDocTitle}_.
endif::[]
