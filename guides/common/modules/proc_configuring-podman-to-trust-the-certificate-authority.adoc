...
[role="_abstract"]
Configure Podman to trust {Project}'s certificate authority by installing the root CA certificate in the Podman certs directory.
Certificate trust enables secure container image pulls from {Project} registries.
