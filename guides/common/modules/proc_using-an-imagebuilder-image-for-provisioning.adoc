...
ifndef::foreman-deb[]
For more information about integrating {Cockpit} with {Project}, see {ManagingHostsDocURL}Host_Management_and_Monitoring_Using_Cockpit_managing-hosts[Host Management and Monitoring Using {Cockpit}] in the _Managing Hosts_ guide.
endif::[]
...
For more information, see {ContentManagementDocURL}Importing_Individual_ISO_Images_and_Files_content-management[Importing Individual ISO Images and Files] in the _Content Management Guide_.
endif::[]
