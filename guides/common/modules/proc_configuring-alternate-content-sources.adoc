...
.Procedure
. In the {ProjectWebUI}, navigate to *Content*{nbsp}>{nbsp}*Alternate Content Sources*.
...
. Navigate to *Content*{nbsp}>{nbsp}*Alternate Content Sources* > click the vertical ellipsis next to the newly created alternate content source > Select *Refresh*.
