...
[id="managing-ostree-content-with-content-views-by-using-web-ui"]
= Managing OSTree content with content views by using {ProjectWebUI}

[role="_abstract"]
Use content views to manage OSTree branches across the application lifecycle by using {ProjectWebUI}.
