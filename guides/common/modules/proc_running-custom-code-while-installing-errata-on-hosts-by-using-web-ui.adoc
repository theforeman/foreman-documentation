...
[id="running-custom-code-while-installing-errata-on-hosts-by-using-web-ui"]
= Running custom code while installing errata on hosts by using {ProjectWebUI}

[role="_abstract"]
You can use custom snippets to run code before and/or after installing errata on hosts in {ProjectWebUI}.
