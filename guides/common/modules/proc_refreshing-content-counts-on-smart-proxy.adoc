...
[role="_abstract"]
Refresh content counts on {SmartProxies} to display current content view and repository availability across lifecycle environments.
Content count updates help monitor and verify content synchronization status.
