...
For more information, see {ContentManagementDocURL}enabling-red-hat-repositories-by-using-web-ui[Enabling Red Hat Repositories] and {ContentManagementDocURL}synchronizing-repositories-on-demand[Synchronizing repositories on demand] in _{ContentManagementDocTitle}_.
