...
For more information, see {ContentManagementDocURL}enabling-red-hat-repositories-by-using-web-ui[Enabling Red Hat Repositories] and {ContentManagementDocURL}synchronizing-repositories-ad-hoc[Synchronizing repositories ad hoc] in _{ContentManagementDocTitle}_.
