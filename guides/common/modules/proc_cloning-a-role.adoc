...
[role="_abstract"]
Clone an existing role in the {ProjectWebUI} to quickly create a new role with similar permissions.
You can edit the cloned role to customize permissions for your environment.
