...
[id="host-facts-settings"]
= Host facts settings

[role="_abstract"]
The facts settings define how {Project} processes and uses facts reported by hosts, including automatic host creation, location and organization assignment, interface updates, and fact filtering.
