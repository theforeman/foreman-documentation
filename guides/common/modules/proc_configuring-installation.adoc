...
If you want to use an external PostgreSQL database, PostgreSQL must be installed on your host. For instructions, see xref TODO[Using external databases with {Project}].
endif::[]
