...
[role="_abstract"]
You can generate host monitoring reports from the {ProjectWebUI} so that you can view host data, such as installed products or compliance status, in a report template.
