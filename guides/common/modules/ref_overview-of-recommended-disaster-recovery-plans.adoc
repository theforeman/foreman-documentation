...
* {AdministeringDocURL}preparing-for-disaster-recovery-and-recovering-from-data-loss[Preparing for disaster recovery and recovering from data loss in _{AdministeringDocTitle}_]
...
ifndef::satellite[]
* {ManagingHostsDocURL}Creating_Snapshots_of_a_Host_managing-hosts[Creating snapshots of a host in _{ManagingHostsDocTitle}_]
endif::[]
endif::[]
