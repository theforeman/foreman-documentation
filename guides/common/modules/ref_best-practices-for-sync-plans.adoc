...
[id="best-practices-for-sync-plans"]
= Best practices for sync plans

[role="_abstract"]
Apply sync plan scheduling and automation patterns that keep content current without overloading {Project} during large synchronizations.
