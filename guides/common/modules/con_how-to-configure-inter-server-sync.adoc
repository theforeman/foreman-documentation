...
ifndef::satellite[]
image::images/common/foreman_iss_disconnected_non_airgapped.png[title="The {Project} ISS Disconnected Scenario", alt="The {Project} ISS Disconnected Scenario"]
endif::[]
ifdef::satellite[]
...
ifndef::satellite[]
image::images/common/foreman_iss_disconnected_airgapped.png[title="The {Project} ISS Air-Gapped Scenario", alt="The {Project} ISS Air-Gapped Scenario"]
endif::[]
ifdef::satellite[]
