...
[id="content-management-settings"]
= Content management settings

[role="_abstract"]
The content settings define how {Project} manages content repositories, subscriptions, content views, and host registration, including default templates, download policies, and synchronization behavior.
