...
|
|assign_locations
|Required if you need to assign locations to hosts or other resources. You can only assign locations that you belong to.
...
|Required if you need to assign organizations to hosts or other resources. You can only assign organizations that you belong to.
