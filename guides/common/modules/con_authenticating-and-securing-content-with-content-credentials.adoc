...
[role="_abstract"]
ifdef::satellite[]
When synchronizing content from upstream sources that use HTTPS and signed packages, import SSL certificates and GPG keys to verify content authenticity and protect against tampering or unauthorized sources.
endif::[]
ifndef::satellite[]
