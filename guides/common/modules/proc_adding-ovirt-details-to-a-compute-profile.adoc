[id="adding-ovirt-details-to-a-compute-profile_{context}"]
...
To use the CLI instead of the {ProjectWebUI}, see the xref:cli-adding-ovirt-details-to-a-compute-profile_{context}[].
...
[id="cli-adding-ovirt-details-to-a-compute-profile_{context}"]
.CLI procedure
...
[options="nowrap" subs="+quotes,attributes"]
----
# hammer compute-profile values create --compute-profile "_My_Compute_Profile_" \
