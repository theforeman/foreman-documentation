...
== Importing a Subscription Manifest into the Satellite Server
...
* Ensure that you enable the disconnected mode on your Satellite Server. For more information, see xref:enabling-the-disconnected-mode[].
