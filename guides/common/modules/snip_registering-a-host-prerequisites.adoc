...
ifdef::satellite[]
* Optional: If you want to register your host to {Insights}, the `{RepoRHEL8BaseOS}` and `{RepoRHEL8AppStream}` repositories are synchronized and made available in the activation key that you use.
