...
ifdef::satellite[]
* Optional: If you want to register your host to {Insights}, the *BaseOS* and *AppStream* repositories must be synchronized and made available in the activation key that you use.
