...
[role="_abstract"]
Refresh subscription manifests after changing subscription allocations, renewing subscriptions, or purchasing additional subscriptions to synchronize entitlement changes.
Manifest updates ensure accurate subscription tracking and content access.
