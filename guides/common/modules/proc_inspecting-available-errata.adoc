...
* On the *Content Hosts* tab, you can apply the erratum to selected content hosts as described in xref:common/modules/con_applying-errata-to-hosts.adoc#applying-errata-to-hosts[].
