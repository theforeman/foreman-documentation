...
[id="synchronizing-{smart-proxy-context}-directory-from-red-hat-cdn"]
= Synchronizing {SmartProxy} directly from Red{nbsp}Hat CDN
...
The {SmartProxy} will now download content from Red{nbsp}Hat CDN and not the {Project}.
