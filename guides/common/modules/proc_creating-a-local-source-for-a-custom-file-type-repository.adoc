...
[role="_abstract"]
You can prepare a directory on {ProjectServer} as a Pulp Manifest source and synchronize files into a {customfiletype} repository, which is useful when you have multiple files to import.
