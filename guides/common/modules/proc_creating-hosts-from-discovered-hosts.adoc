...
For information about the security tokens, see xref:Configuring_the_Security_Token_Validity_Duration[].
...
For more information, see xref:creating-hosts-with-pxe-provisioning[].
endif::[]