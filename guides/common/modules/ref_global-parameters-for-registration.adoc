...
* {ManagingConfigurationsPuppetDocURL}configuring-openvox-agent-on-a-host-during-registration[Configuring OpenVox agent on a host during registration in _{ManagingConfigurationsPuppetDocTitle}_]
