...
[id="installing-{smart-proxy-context}-servers"]
...
You register each {SmartProxyServer} to {ProjectServer} and configure it to provide the required services within your {Project} deployment.
...
* {InstallingSmartProxyDocURL}[_{InstallingSmartProxyDocTitle}_]
ifdef::katello,satellite,orcharhino[]
ifndef::containerized[]
* {TuningDocURL}Smart_Proxy_Configuration_Tuning_performance-tuning[{SmartProxy} configuration tuning in _{TuningDocTitle}_]
endif::[]
endif::[]
