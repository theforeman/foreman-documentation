...
[id="adding-an-amazon-ec2-connection-to-server-by-using-web-ui"]
= Adding an Amazon EC2 connection to {ProjectServer} by using {ProjectWebUI}

[role="_abstract"]
Use this procedure to add the Amazon EC2 connection to the compute resources of your {ProjectServer}.
...
For more information, see xref:http-proxy-for-communication-with-{compute-resource-context}[].
