...
[id="running-custom-code-while-installing-errata-on-hosts-by-using-cli"]
= Running custom code while installing errata on hosts by using Hammer CLI

[role="_abstract"]
You can use custom snippets to run code before and/or after installing errata on hosts by using Hammer CLI.
