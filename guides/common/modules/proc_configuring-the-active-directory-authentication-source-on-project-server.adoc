...
[id="configuring-the-active-directory-authentication-source-on-{project-context}-server"]
...
--negotiate \
--user : \
https://_{foreman-example-com}_/users/extlogin
----
+
...
ifdef::katello[]
+
For information on configuring system-wide cryptographic policies, see link:https://docs.redhat.com/en/documentation/red_hat_enterprise_linux/10/html/security_hardening/using-system-wide-cryptographic-policies[Using system-wide cryptographic policies] in _{RHEL}{nbsp}10 Security hardening_.
+
[NOTE]
====
For containerized {Katello} users, select the reference related to your current operating system.
...
ifdef::containerized[]
* https://docs.redhat.com/en/documentation/red_hat_enterprise_linux/10/html/configuring_authentication_and_authorization_in_rhel/configuring_applications_for_sso#Configuring_Firefox_to_use_Kerberos_for_SSO[Configuring Firefox to use Kerberos for single sign-on in _{RHEL}{nbsp}10 Configuring authentication and authorization in RHEL_]
endif::[]
ifdef::containerized[]
ifdef::katello[]
[NOTE]
