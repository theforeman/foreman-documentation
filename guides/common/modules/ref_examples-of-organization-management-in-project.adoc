...
[role="_abstract"]
You can use organizations to structure your content and system administration based on your business needs, whether you run a small business, a large company with multiple business units, or manage systems for external customers.
