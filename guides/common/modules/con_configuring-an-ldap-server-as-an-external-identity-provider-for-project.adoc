...
For more information on using {FreeIPA} as an authentication method, see xref:configuring-a-freeipa-server-as-an-external-identity-provider-for-project_{context}[].
====
