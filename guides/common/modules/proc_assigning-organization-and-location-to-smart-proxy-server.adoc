...
[id="assigning-organization-and-location-to-{smart-proxy-context}-server_{context}"]
= Assigning organization and location to {SmartProxyServer}

[role="_abstract"]
Assign the correct organization and location to {SmartProxyServer} to properly manage your {SmartProxyServer} within your organizational structure.
