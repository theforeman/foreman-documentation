...
[role="_abstract"]
You can view general information about your {SmartProxies} in the {ProjectWebUI}, such as their status, enabled features, and managed hosts, to verify configuration or troubleshoot connectivity issues.
