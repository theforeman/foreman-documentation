...
In the *Features* column you can verify if {SmartProxy} for example, provides a DHCP service or acts as a Pulp mirror.
endif::[]
ifdef::foreman-el,foreman-deb[]
In the *Features* column you can verify if {SmartProxy} for example, provides a DHCP service.
endif::[]
