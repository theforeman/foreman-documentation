...
[id="{project-context}-deployment-scenarios-on-aws"]
= {Project} deployment scenarios on AWS
...
image::aws-one-region-setup.png[One-region setup]
endif::[]
ifdef::satellite[]
image::aws-one-region-setup-satellite.png[One-region setup]
endif::[]
ifdef::orcharhino[]
image::aws-one-region-setup-orcharhino.svg[One-region setup]
endif::[]
...
ifdef::foreman-el,foreman-deb,katello[]
image::aws-combined-vpn.png[Site-to-site VPN connection between the AWS region and the on-premises data center]
endif::[]
ifdef::satellite[]
image::aws-combined-vpn-satellite.png[Site-to-site VPN connection between the AWS region and the on-premises data center]
endif::[]
ifdef::orcharhino[]
image::aws-combined-vpn-orcharhino.svg[Site-to-site VPN connection between the AWS region and the on-premises data center]
endif::[]
+
.Direct connection using the external DNS host name
ifdef::foreman-el,foreman-deb,katello[]
image::aws-combined-direct.png[Direct connection using the external DNS host name]
endif::[]
ifdef::satellite[]
image::aws-combined-direct-satellite.png[Direct connection using the external DNS host name]
endif::[]
ifdef::orcharhino[]
image::aws-combined-direct-orcharhino.svg[Direct connection using the external DNS host name]
endif::[]
...
ifdef::foreman-el,foreman-deb,katello[]
image::aws-multi-region-vpn.png[Site-to-site VPN connection between AWS regions]
endif::[]
ifdef::satellite[]
image::aws-multi-region-vpn-satellite.png[Site-to-site VPN connection between AWS regions]
endif::[]
ifdef::orcharhino[]
image::aws-multi-region-vpn-orcharhino.svg[Site-to-site VPN connection between AWS regions]
endif::[]
+
.Direct connection using the external DNS host name
ifdef::foreman-el,foreman-deb,katello[]
image::aws-multi-region-direct.png[Direct connection using the external DNS host name]
endif::[]
ifdef::satellite[]
image::aws-multi-region-direct-satellite.png[Direct connection using the external DNS host name]
endif::[]
ifdef::orcharhino[]
image::aws-multi-region-direct-orcharhino.svg[Direct connection using the external DNS host name]
endif::[]
