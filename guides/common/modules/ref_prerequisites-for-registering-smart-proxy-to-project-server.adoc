...
= Prerequisites for registering {SmartProxy} to {ProjectServer}

[role="_abstract"]
Your environment must meet the following requirements before you can register {SmartProxy} to your {ProjectServer}.
