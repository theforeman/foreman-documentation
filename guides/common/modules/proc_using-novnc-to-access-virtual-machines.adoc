...
For more information, see the {AdministeringDocURL}sect-Administering-Installing_the_Katello_Root_CA_Certificate[Installing the Katello Root CA Certificate] section in the _Administering {ProjectName}_ guide.
