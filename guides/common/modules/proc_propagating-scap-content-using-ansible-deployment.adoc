...
[role="_abstract"]
Promote Security Content Automation Protocol (SCAP) content through the load balancer when using Ansible deployment so that compliance reports reach {Project} through the load balancer.
