...
[id="host-discovery-settings"]
= Host Discovery settings

[role="_abstract"]
The Discovery settings define how {Project} handles discovered hosts, including default organization and location assignment, hostname generation, auto-provisioning behavior, and fact organization.
