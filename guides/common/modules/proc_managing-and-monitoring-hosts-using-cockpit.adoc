...
* For more information about installing {the-Cockpit}, see https://cockpit-project.org/running.html[Running Cockpit].
endif::[]
ifdef::satellite[]
* For more information about getting started with Red Hat web console, see the following documents:
