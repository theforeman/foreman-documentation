...
ifdef::satellite[]
* {RHELDocsBaseURL}10/html/managing_systems_using_the_rhel_10_web_console/index[_Managing systems using the RHEL{nbsp}10 web console_]
* {RHELDocsBaseURL}10/html/composing_a_customized_rhel_system_image/creating-system-images-with-composer-web-console-interface_composing-a-customized-rhel-system-image#accessing-composer-gui-in-the-rhel-10-web-console_creating-system-images-with-composer-web-console-interface[_Accessing the RHEL image builder dashboard in the RHEL web console_ in _Composing a customized RHEL system image_ (RHEL 10)]
endif::[]
