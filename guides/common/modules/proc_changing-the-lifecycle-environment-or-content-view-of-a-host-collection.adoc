...
[role="_abstract"]
You can change the lifecycle environment or content view assigned to a host collection so that all hosts in the collection consume content from the new lifecycle environment or content view.
