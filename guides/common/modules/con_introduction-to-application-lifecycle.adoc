...
[role="_abstract"]
The _application lifecycle_ organizes how hosts and software appear at each stage of delivery.
In {Project}, each stage is a lifecycle environment backed by a content view that selects repositories and packages for hosts registered to that stage.
