...
* For {ProjectServer}, see {InstallingServerDocURL}preparing-your-environment-for-{project-context}-server-installation[Preparing your environment for {ProjectServer} installation] in _{InstallingServerDocTitle}_.
* For {SmartProxyServers}, see {InstallingSmartProxyDocURL}preparing-your-environment-for-{smart-proxy-context}-installation[Preparing your environment for {SmartProxy} installation] in _{InstallingSmartProxyDocTitle}_.
endif::[]
...
* https://docs.aws.amazon.com/directconnect/latest/UserGuide/Welcome.html[What is AWS Direct Connect?]
