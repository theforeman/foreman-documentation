...
[role="_abstract"]
Export content from an upstream {ProjectServer} and import it into a downstream server when network connectivity is limited or air gapped, choosing an approach based on what content you need to synchronize.
