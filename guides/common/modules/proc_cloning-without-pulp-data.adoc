...
.Procedure
. Follow the steps in the procedure in xref:preparing-the-source-server-for-cloning[] and replace the steps that involve cloning with Pulp data with the following steps:
