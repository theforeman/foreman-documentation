...
[id="background-tasks-settings"]
= Background tasks settings

[role="_abstract"]
The tasks settings define how {Project} manages background tasks, including timeouts, retry behavior, batch processing, and debugging options for the Dynflow console.
