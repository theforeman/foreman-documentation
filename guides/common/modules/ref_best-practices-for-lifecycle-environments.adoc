...
[id="best-practices-for-lifecycle-environments"]
= Best practices for lifecycle environments

[role="_abstract"]
Design lifecycle environment paths, plan promotions, and configure {SmartProxyServer} content synchronization for predictable staging from development to production.
