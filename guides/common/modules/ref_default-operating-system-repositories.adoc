...
[role="_abstract"]
Reference default operating system repositories for supported client operating systems to configure content synchronization.
Repository tables organize products and repositories by operating system type and version.
