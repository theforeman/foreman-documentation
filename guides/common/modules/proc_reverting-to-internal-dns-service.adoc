...
For more information about answer files, see {BaseURL}installing_satellite_server_from_a_connected_network/installing_satellite_server#specifying_installation_options[Specifying Installation Options].
