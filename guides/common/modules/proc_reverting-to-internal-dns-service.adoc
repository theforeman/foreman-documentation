...
For more information about answer files, see link:{InstallingProjectDocURL}installing-satellite-server-connected#configuring-server_satellite[Configuring {ProjectServer}].
