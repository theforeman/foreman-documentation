...
[role="_abstract"]
Run a full offline backup on {ProjectServer} or {SmartProxyServer} to capture all {Project} content and configuration.
...
[options="nowrap", subs="+quotes,verbatim,attributes"]
----
# {foremanctl} backup _/var/foreman-proxy-backup_
----
endif::[]
ifndef::containerized[]
[options="nowrap", subs="+quotes,verbatim,attributes"]
