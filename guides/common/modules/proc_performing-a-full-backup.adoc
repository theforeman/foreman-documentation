...
* Online backup
+
With online backups, the {Project} services are online while the backup process is running.
The {Project} services are shut down during an offline backup, resulting in a more consistent backup.
