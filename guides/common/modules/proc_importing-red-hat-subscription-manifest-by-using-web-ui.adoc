...
= Importing Red Hat subscription manifest by using web UI

[role="_abstract"]
You can import a Red{nbsp}Hat subscription manifest into {ProjectServer} by using the {ProjectWebUI}.
