...
For more information, see xref:adding-installation-media_provisioning[].
endif::[]
ifeval::["{build}" != "satellite"]
. Click the Installation Media tab and enter the information for the installation media source.
For more information, see or more information, see xref:adding-installation-media_provisioning[].
endif::[]
