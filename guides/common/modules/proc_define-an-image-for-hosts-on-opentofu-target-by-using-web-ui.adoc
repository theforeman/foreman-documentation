...
.Next steps
* Create a compute profile that uses this image.
For more information, see xref:create-a-predefined-configuration-for-hosts-on-{compute-resource-target-id}-by-using-web-ui[].
