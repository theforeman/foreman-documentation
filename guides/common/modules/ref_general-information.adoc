...
[role="_abstract"]
Review essential information for using Hammer CLI in {ProjectName}.
There are certain options that apply to all commands, such as authentication and getting help.
