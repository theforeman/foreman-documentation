...
[role="_abstract"]
Review essential information for using Hammer CLI in {ProjectName} effectively.
There are certain options that apply to all commands, including authentication and getting help.
