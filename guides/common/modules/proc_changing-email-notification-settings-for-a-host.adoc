...
[role="_abstract"]
You can enable or disable email notifications for a host to control whether its events trigger alerts.
{Project} sends these notifications to the registered owner of the host.
...
The help text for this checkbox is *Include this host within {Project} reporting*.
