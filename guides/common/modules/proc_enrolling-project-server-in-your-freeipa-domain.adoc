...
ifndef::orcharhino[]
+
For more information, see link:https://docs.redhat.com/en/documentation/red_hat_enterprise_linux/10/html-single/installing_identity_management/index#assembly_installing-an-idm-client_installing-identity-management[{RHEL}{nbsp}10 Installing Identity Management].
endif::[]
endif::[]
ifdef::foreman-deb[]
