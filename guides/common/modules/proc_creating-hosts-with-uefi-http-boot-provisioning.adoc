...
In the {ProjectWebUI}, navigate to *Infrastructure*{nbsp}>{nbsp}*{SmartProxies}* and click on {SmartProxy} to see the list of recognized features.
...
In the {ProjectWebUI}, navigate to *Infrastructure*{nbsp}>{nbsp}*Subnets* > *Edit Subnet* > *{SmartProxies}* and select the {SmartProxy} for both *TFTP* and *HTTPBoot* options.
. Click *OK* to save.
