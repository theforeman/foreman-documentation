...
+
Alternatively,  you can configure the host to use container certificates for authentication.
...
After setting up container certificates, you do not need to run `podman login`.
+
