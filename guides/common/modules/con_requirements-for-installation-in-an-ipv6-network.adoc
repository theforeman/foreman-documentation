...
ifdef::satellite[]
* If you plan to provision hosts from {Project} or {SmartProxies}, you must install {Project} and {SmartProxies} on {RHEL} version 8.3 or higher because these versions include the latest version of the `grub2` package.
endif::[]
