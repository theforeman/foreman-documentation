...
[id="enabling-{smart-proxy-context}-in-project-web-ui"]
= Enabling {SmartProxy} in {ProjectWebUI}

[role="_abstract"]
Assign the correct organization and location to {SmartProxyServer} to ensure it appears in the {ProjectWebUI}
That way, you can properly manage your {SmartProxyServer} within your organizational structure.
