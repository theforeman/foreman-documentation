...
. Optional: On the *Host Collections* tab, click *Add* to view a list of available host collections.
Select your host collection and click *Add Selected*.
This ensures that hosts become part of your host collection during the host registation process.
