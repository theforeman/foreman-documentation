...
| *_example_software_-2.0-0.noarch.rpm* | _example_software_-1.1-0.noarch.rpm | _example_software_-1.0-0.noarch.rpm
|===
...
| _example_software_-2.0-0.noarch.rpm | _example_software_-2.0-0.noarch.rpm | *_example_software_-2.0-0.noarch.rpm*
|===
