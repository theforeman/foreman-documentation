...
* If several teams in your organization manage {SmartProxies} across different locations.
...
ifdef::orcharhino[]
{SmartProxies} at version {ProjectVersionPrevious} retain all of their earlier functionality.
endif::[]
ifndef::orcharhino[]
