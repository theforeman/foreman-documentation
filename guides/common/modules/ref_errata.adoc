...
[role="_abstract"]
Use Hammer CLI commands to manage security updates and patches in {ProjectName}.
List, inspect, and apply errata to keep your hosts secure and up-to-date by using these commands.
