...
[role="_abstract"]
You can use {Project} to override Ansible variables for roles imported into {Project}.
This helps you customize the behavior of imported roles to fit your specific needs.
...
.Prerequisites
* Ansible variables are available in {Project}.
