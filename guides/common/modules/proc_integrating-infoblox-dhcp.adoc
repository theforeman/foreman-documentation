...
With the integration, you can use your existing DHCP server, and {Project} manages IP leases and boot configurations on the DHCP server during the provisioning of hosts.
