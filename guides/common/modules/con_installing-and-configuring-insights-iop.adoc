...
For more information, see xref:configuring-podman-network-backend-for-iop_{context}[].
====

{insights-iop} follows the standard lifecycle policy for {ProjectName}.
To update {insights-iop}, follow the standard update instructions for {Project}.
