...
[role="_abstract"]
Extract GPG key fingerprints from Debian `Release` files when you need to verify Deb repository signatures.
...
For more information, see xref:importing-content-credentials-by-using-web-ui[] into {Project}.
