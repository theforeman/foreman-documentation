...
* For more information on synchronizing repositories, see {ContentManagementDocURL}repository-synchronization[Repository synchronization] in _{ContentManagementDocTitle}_.
