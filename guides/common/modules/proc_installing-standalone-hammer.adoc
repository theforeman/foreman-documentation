...
* link:{ManagingHostsDocURL}Enabling_Custom_Repositories_on_Content_Hosts_managing-hosts[Enabling repositories on hosts in _{ManagingHostsDocTitle}_]
* link:{ManagingHostsDocURL}Registering_Hosts_by_Using_Global_Registration_managing-hosts[Registering hosts by using global registration in _{ManagingHostsDocTitle}_]
* link:{ContentManagementDocURL}Synchronizing_Repositories_content-management[Synchronizing repositories in _{ContentManagementDocTitle}_]
endif::[]
