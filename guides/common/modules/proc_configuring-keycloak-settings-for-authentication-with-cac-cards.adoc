...
= Configuring {keycloak-wildfly} settings for authentication with {PIV} cards

You must configure {keycloak-wildfly} settings for authentication with {PIV} cards.

.Procedure

. In the {keycloak-wildfly} web UI, navigate to the *Authentication* tab.
