...
= Configuring {Keycloak-SSO} settings for authentication with {PIV} cards

You must configure {Keycloak-SSO} settings for authentication with {PIV} cards.

.Procedure

. In the {Keycloak-SSO} web UI, navigate to the *Authentication* tab.
