...
* {InstallingSmartProxyDocURL}configuring-{smart-proxy-context}-server-with-ssl-certificates_connected[Configuring {SmartProxyServer} with SSL certificates in _{InstallingSmartProxyDocTitle}_]
