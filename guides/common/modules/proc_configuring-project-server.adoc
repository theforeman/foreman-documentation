...
.Prerequisites
<<<<<<< HEAD
* If you want to use an external PostgreSQL database for your {ProjectServer}, set up the external PostgreSQL server with the required databases and user permissions.
=======
* If you want to use an external PostgreSQL database with your {ProjectServer}, you have prepared a PostgreSQL server with the required databases and user permissions.
>>>>>>> 79eadefb6a (Apply changes suggested in PR)
