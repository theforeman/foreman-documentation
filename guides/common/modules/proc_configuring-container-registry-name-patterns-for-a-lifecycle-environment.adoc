...
[role="_abstract"]
Set a registry name pattern for a lifecycle environment to override default container image names and avoid naming conflicts when you pull images from {Project}.
