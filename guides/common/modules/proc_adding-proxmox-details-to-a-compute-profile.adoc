...
[id="adding-proxmox-details-to-a-compute-profile"]
...
. From the *ISO Upload Storage* list, select the storage path used by {Project} to upload ISO images and boot disks to Proxmox.
