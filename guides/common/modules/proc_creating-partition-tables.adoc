...
For example, Red Hat Enterprise Linux, CentOS, and Fedora are in the Red Hat family.
...
For example, Red Hat Enterprise Linux 7.2 requires a layout that matches a kickstart file.
+
