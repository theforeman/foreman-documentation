...
* In the {ProjectWebUI}, navigate to *Configure* > *RH Cloud* > *Insights* where the vertical ellipsis next to the *Remediate* button provides a *View in Red{nbsp}Hat Insights* link to the general recommendations page.
...
. In the {ProjectWebUI}, navigate to *Configure* > *RH Cloud* > *Insights*.
. Click *Start Recommendations Sync*.
...
. In the {ProjectWebUI}, navigate to *Configure* > *RH Cloud* > *Inventory Upload*.
