...
You have now assigned the correct organization and location to {SmartProxyServer}. Select the organization and location in the {Project} web UI, and verify if the {SmartProxyServer} is listed in the following locations by navigating to:
