...
[role="_abstract"]
Assign the correct organization and location to {SmartProxyServer} to ensure it appears in the {ProjectWebUI} and can be properly managed within your organizational structure.
