...
[IMPORTANT]
====
You can only assign locations to resources if you belong to those locations and have the `assign_locations` permission.
If you try to assign a location that you do not belong to, {Project} displays an error message: "Invalid locations selection, you must select at least one of yours and have 'assign_locations' permission."
====
