...
[id="composite-content-views-overview"]
...
Use it when hosts need content from multiple content views, such as an operating system and an application, managed separately.
