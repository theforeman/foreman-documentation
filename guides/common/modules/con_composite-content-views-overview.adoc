...
[role="_abstract"]
Combine content from multiple content views into a single composite content view to manage complex application stacks.
For example, you can compose a stack of an operating system, database, and application into a composite content view to simplify deployment.
