...
[role="_abstract"]
Propagate Security Content Automation Protocol (SCAP) content through the load balancer when using Puppet deployment so that compliance reports reach {Project} through the load balancer.
