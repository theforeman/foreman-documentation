...
{project-allcaps} = "{foreman-example-com}"
# URL for the API to your deployed {ProjectX} server
{project-allcaps}_API = f"https://{{project-allcaps}}/api/"
KATELLO_API = f"https://{{project-allcaps}}/katello/api/v2/"
