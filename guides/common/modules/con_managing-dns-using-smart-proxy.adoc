...
ifndef::foreman-deb[]
For more information, see {IntegratingExternalServicesDocURL}configuring-dynamic-dns-update-with-gss-tsig-authentication_external-services[Configuring dynamic DNS update with GSS-TSIG authentication] in _{IntegratingExternalServicesDocTitle}_.
endif::[]
ifndef::satellite[]
