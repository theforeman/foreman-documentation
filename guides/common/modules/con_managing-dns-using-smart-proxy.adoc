...
For more information, see {ConfiguringExternalServicesDocURL}configuring-dynamic-dns-update-with-gss-tsig-authentication_external-services[Configuring dynamic DNS update with GSS-TSIG authentication] in _{ConfiguringExternalServicesDocTitle}_.
ifndef::satellite[]
...
For more information, see https://projects.theforeman.org/projects/foreman/wiki/List_of_Smart-Proxy_Plugins#DNS-plugins[List of DNS plug-ins]
endif::[]
