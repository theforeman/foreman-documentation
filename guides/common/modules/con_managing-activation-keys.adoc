...
[role="_abstract"]
Activation keys automate host registration in {Project} by assigning subscriptions, repositories, content view environments, and system purpose.
You can create and configure keys in the web UI or with Hammer CLI and apply best practices when using multiple keys.
