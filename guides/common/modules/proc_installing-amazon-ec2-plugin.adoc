...
----
. Optional: In the {ProjectWebUI}, navigate to *Administer*{nbsp}>{nbsp}*About* and select the *compute resources* tab to verify the installation of the Amazon EC2 plugin.
