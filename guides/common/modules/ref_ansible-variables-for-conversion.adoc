...
[role="_abstract"]
Configure the required Ansible variables for the Convert2RHEL role before you run it to generate conversion data on {ProjectServer}.
This reference lists the variables and their intended values.
