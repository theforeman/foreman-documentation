...
[role="_abstract"]
Filter content in your content views to include or restrict specific packages, errata, and module streams.
Content filters enable you to create tailored repositories that contain only the content your hosts need.
