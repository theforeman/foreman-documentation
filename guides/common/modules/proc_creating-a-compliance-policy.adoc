...
For more information about importing Ansible roles, see {ManagingConfigurationsAnsibleDocURL}getting-started-with-ansible_ansible[Getting Started with Ansible in {Project}] in _{ManagingConfigurationsAnsibleDocTitle}_.

.Procedure
. In the {ProjectWebUI}, navigate to *Hosts*{nbsp}>{nbsp}*Policies*, and select whether you want a manual, Ansible, or Puppet deployment.
