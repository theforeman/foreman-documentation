...
ifndef::satellite[]
* {AdministeringDocURL}limiting-host-resources[Limiting host resources in _{AdministeringDocTitle}_]
endif::[]
ifndef::satellite,orcharhino[]
* https://github.com/theforeman/foreman/blob/develop/developer_docs/how_to_create_a_plugin.asciidoc[How to Create a Plugin]
* https://github.com/theforeman/foreman/blob/develop/developer_docs/slot-and-fill.asciidoc[Slot and Fill]
endif::[]
