...
You can install and configure the OpenVox agent during registration when you manage configuration with Puppet by setting host parameters before you register the host.
