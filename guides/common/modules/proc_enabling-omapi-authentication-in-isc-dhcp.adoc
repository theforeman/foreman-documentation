...
The integration of an existing remote ISC DHCP service requires that you enable the Object Management Application Programming Interface (OMAPI) in the DHCP service. {Project} uses OMAPI to remotely manage DHCP server objects.
