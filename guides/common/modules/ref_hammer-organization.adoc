...
`upstream_server` type.
* `--url xref:hammer-option-details-value[VALUE]` {endash} Upstream foreman server to sync CDN content from. Relevant only for
`upstream_server` type.
...
* `--environments xref:hammer-option-details-list[LIST]`
...
* `--puppet-environment-ids xref:hammer-option-details-list[LIST]` {endash} IDs of associated Puppet environment
* `--puppet-environments xref:hammer-option-details-value[VALUE]` {endash} Names of associated Puppet environment
...
* `--smart-proxy-ids xref:hammer-option-details-list[LIST]` {endash} Smart proxy IDs
