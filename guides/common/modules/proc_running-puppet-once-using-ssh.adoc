...
[role="_abstract"]
Assign the job template to the _Run Puppet Once_ feature to apply Puppet configuration on selected hosts immediately without waiting for the next scheduled run.
