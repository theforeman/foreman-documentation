...
Users in {Project} can have one or more roles attached.
...
Roles related to specific tasks:: For example, role of a security manager or role of a license manager.

ifeval::["{context}" == "planning"]
.Additional resources
* For more information, see link:{AdministeringDocURL}Managing_Users_and_Roles_admin[_{AdministeringDocTitle}_].
endif::[]
