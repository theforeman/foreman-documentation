:_mod-docs-content-type: PROCEDURE
  ...
  * Open the following URL in a browser: http://_{foreman-example-com}_:3000
  ...
  include::proc_accessing-grafana-remotely-ssh-tunnel-linux-macos.adoc[leveloffset=+1]
  
  include::proc_accessing-grafana-remotely-ssh-tunnel-windows-putty.adoc[leveloffset=+1]
  
  include::proc_accessing-grafana-remotely-ssh-tunnel-windows-powershell.adoc[leveloffset=+1]
