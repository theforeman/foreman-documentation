...
Use the following procedures to clone your {ProjectServer}.
...
You can clone your {ProjectServer} to create instances to test upgrades and the migration of instances to a different machine or operating system.
This is an optional step to provide more flexibility during the upgrade.

include::snip_backup_usecase_note.adoc[]
