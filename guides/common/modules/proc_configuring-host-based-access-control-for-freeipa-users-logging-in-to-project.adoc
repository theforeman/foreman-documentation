...
For more information, see xref:configuring-the-freeipa-authentication-source-on-{project-context}-server[].
endif::[]
...
ifndef::orcharhino[]
+
For more information, see https://docs.redhat.com/en/documentation/red_hat_enterprise_linux/10/html/managing_idm_users_groups_hosts_and_access_control_rules/configuring-host-based-access-control-rules[_{RHEL}{nbsp}10 Managing IdM users, groups, hosts, and access control rules_].
endif::[]
endif::[]
