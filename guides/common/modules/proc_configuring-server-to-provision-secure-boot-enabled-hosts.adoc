...
----
+
* To use one and the same shim and GRUB2 binaries for all versions of the operating system of your target host, replace {secureboot-os-version} with `default`.
* If you require specific versions of the shim and GRUB2 binaries for the version of the operating system of your target host, use the *Major* and *Minor* version of the operating system separated by a dot (`.`) as {secureboot-os-version}.
If no *Minor* version is set, then use the *Major* version as {secureboot-os-version}.
+
