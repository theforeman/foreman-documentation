...
[id="automatic-contexts-for-discovered-hosts"]
= Automatic contexts for discovered hosts

[role="_abstract"]
{ProjectServer} automatically assigns an organization and location to discovered hosts automatically.

{ProjectServer} assigns organizations and locations to discovered hosts according to the following sequence of rules:
