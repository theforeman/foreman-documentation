...
[id="importing-a-repository"]
= Importing a repository

[role="_abstract"]
You can import an exported repository into an organization on a downstream {ProjectServer} to match content from the upstream server.
...
* If the export contains any Red{nbsp}Hat repositories, the subscription manifest of the importing organization must contain subscriptions for the products contained within the export.
endif::[]
