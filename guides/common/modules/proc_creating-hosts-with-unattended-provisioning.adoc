...
+
For more information about associating provisioning templates, see xref:common/modules/con_provisioning-templates.adoc#provisioning-templates[Provisioning templates].
