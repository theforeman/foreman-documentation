...
[id="pxe-booting-in-{project-context}"]
= PXE booting in {Project}
...
ifdef::satellite[]
* https://access.redhat.com/solutions/163253[How to set-up/configure a PXE Server in the Red{nbsp}Hat Knowledgebase]
endif::[]
* xref:networking-considerations-in-{project-context}[]
