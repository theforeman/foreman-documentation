...
[id="importing-ostree-content-by-using-web-ui"]
= Importing OSTree content by using {ProjectWebUI}

[role="_abstract"]
You can import and synchronize OSTree content from custom online sources over HTTPS by using {ProjectWebUI}.
