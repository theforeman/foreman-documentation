...
[role="_abstract"]
Choose between composite content views and multiple content view environments to grant hosts access to content from multiple sources.
Each approach offers different timing, conflict resolution, and version selection capabilities to match your workflow needs.
