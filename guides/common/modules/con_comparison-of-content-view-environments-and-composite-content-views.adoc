...
[role="_abstract"]
Compare composite content views and content view environments to decide how hosts access content from more than one content view.
The differences include access timing, conflict resolution, and version selection.
