...
[role="_abstract"]
You can export a content view version to an archive file and recreate the same version on another {ProjectServer}. {Project} exports composite content views as regular content views.
