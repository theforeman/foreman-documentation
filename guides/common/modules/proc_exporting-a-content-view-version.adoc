...
[role="_abstract"]
Export content view versions to archive files for replication across multiple {ProjectServer}s or organizations.
Exports enable content migration and synchronization in disconnected environments.
