...
[role="_abstract"]
Upload individual binary RPMs through the {ProjectWebUI} when you must seed a custom Yum repository without an upstream mirror; use xref:uploading-content-to-custom-rpm-repositories-by-using-cli[] for source RPM uploads.
