...
[role="_abstract"]
You upload binary RPM packages in {ProjectWebUI} to populate custom repositories without synchronizing from an upstream URL.
Use Hammer CLI when you must upload source RPM packages.
