...
For more information, see {AdministeringDocURL}configuring-{project-context}-for-{insights-id}-analytics[Configuring {Project} for {Insights} analytics] in _{AdministeringDocTitle}_.
