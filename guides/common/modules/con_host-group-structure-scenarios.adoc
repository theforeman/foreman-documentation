...
[id="host-group-structure-scenarios"]
= Host group structure scenarios
...
image::planning-for-foreman-host-group-structures.svg[Host group structuring examples]
endif::[]
ifdef::orcharhino[]
image::planning-for-foreman-host-group-structures-orcharhino.svg[Host group structuring examples]
endif::[]
ifdef::satellite[]
