...
----
# {foreman-installer} features
----
+
You can enable one or more features by adding the `--add-feature _Feature-1_ _Feature-2_` option to the `{foreman-installer} deploy` command.
