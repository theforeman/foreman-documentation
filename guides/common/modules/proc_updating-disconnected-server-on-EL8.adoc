...
You can update your disconnected {Project} on {RHEL} 8 by synchronizing the required repositories on the c
onnected {Project} and syncing the content to the disconnected {Project} using `reposync`.
