...
ifdef::katello[]
| `{Project} Client` | `{project-client-url}/el10/x86_64/`
endif::[]
ifdef::orcharhino[]
| `{Project} Client` | see {atix-kb-clients} in the _ATIX Service Portal_
endif::[]
|===
...
ifdef::katello[]
| `{Project} Client` | `{project-client-url}/el9/x86_64/`
endif::[]
ifdef::orcharhino[]
| `{Project} Client` | see {atix-kb-clients} in the _ATIX Service Portal_
endif::[]
...
ifdef::katello[]
| `{Project} Client` | `{project-client-url}/el8/x86_64/`
endif::[]
ifdef::orcharhino[]
| `{Project} Client` | see {atix-kb-clients} in the _ATIX Service Portal_
endif::[]
