...
[role="_abstract"]
Use these example repository names and upstream URLs when you synchronize Oracle Linux BaseOS, AppStream, addons on yum.oracle.com, and {project-client-name} content.
