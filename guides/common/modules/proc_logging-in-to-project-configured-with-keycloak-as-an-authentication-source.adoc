...
----
$ hammer auth login oauth \
--oidc-token-endpoint 'https://_{keycloak-example-com}_/realms/_{Project}_realm_/protocol/openid-connect/token' \
--oidc-authorization-endpoint 'https://_{keycloak-example-com}_' \
--oidc-client-id '_{foreman-example-com}_-hammer-openidc' \
--oidc-redirect-uri urn:ietf:wg:oauth:2.0:oob
----
