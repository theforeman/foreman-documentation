...
Each type of PXE Loader categories delivers boot loaders and installation files during network provisioning.
In {Project}, you can select from the following PXE Loader categories:
