[id="creating-hosts-with-tftp-boot-provisioning"]
= Creating hosts with TFTP boot provisioning
...
To use the CLI instead of the {ProjectWebUI}, see the xref:cli-creating-hosts-with-tftp-boot-provisioning[].
...
[id="cli-creating-hosts-with-tftp-boot-provisioning"]
.CLI procedure
