...
. In the IdM web UI, navigate to *Network Services* > *DNS*{nbsp}>{nbsp}*DNS Zones* and click the name of the zone.
...
. To view the entry in the IdM web UI, navigate to *Network Services* > *DNS*{nbsp}>{nbsp}*DNS Zones*.
