...
[role="_abstract"]
You can add a {customfiletype} repository to an existing {customproduct} in {ProjectWebUI} by selecting the file repository type, following the same workflow as creating other {customcontent}.
