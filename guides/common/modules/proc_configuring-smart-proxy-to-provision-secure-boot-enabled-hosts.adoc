...
[options="nowrap" subs="+quotes,verbatim,attributes"]
----
# BOOTLOADER_PATH="_My_Bootloader_Directory_/pxegrub2/_{secureboot-os-name}_/default/_{secureboot-os-architecture}_"
----
+
If you require specific versions of the shim and GRUB2 binaries for the version of the operating system of your target host, replace `default` with the *Major* and *Minor* version of the operating system separated by a dot.
