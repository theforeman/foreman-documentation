...
[role="_abstract"]
Extract SUSE installation media on {ProjectServer} to provision hosts in disconnected environments without external network access.
Local installation media enables offline provisioning and reduces dependency on internet connectivity.
