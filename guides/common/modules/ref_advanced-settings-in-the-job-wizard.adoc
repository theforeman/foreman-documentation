...
+
ifdef::satellite[]
With *Allow {SmartProxy} batch tasks*
endif::[]
ifndef::satellite[]
With *Allow proxy batch tasks*
endif::[]
set to `Yes`, you can also control the number of tasks your {SmartProxy} receives at once from starting a remote execution job.
