...
. Locate the *OIDC JWKs URL* row, and in the *Value* column, set the value to *_https://{Keycloak-short}.com:8443/auth/realms/{Project}_Realm/protocol/openid-connect/certs_*.
