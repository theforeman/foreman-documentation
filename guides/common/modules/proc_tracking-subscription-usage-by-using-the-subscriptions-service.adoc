...
You can configure your {ProjectServer} to report usage data to the {RHCloud} by enabling and adjusting the `foreman_rh_cloud` plugin.
...
Connected {Project}::
Configure the `foreman_rh_cloud` plugin to share inventory information with the {RHCloud}.
