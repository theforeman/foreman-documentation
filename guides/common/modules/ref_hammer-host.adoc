...
* `--content-source-id xref:hammer-option-details-number[NUMBER]` {endash} Id of the capsule from which the host consumes content.
...
* `--enabled xref:hammer-option-details-boolean[BOOLEAN]` {endash} Include this host within Satellite reporting
...
* `--ip xref:hammer-option-details-value[VALUE]` {endash} Not required if using a subnet with DHCP Capsule
...
* `--domain xref:hammer-option-details-value[VALUE]` {endash} Domain name
* `--domain-id xref:hammer-option-details-number[NUMBER]` {endash} Satellite domain ID of interface. Required for primary interfaces on managed
hosts.
...
* `--subnet xref:hammer-option-details-value[VALUE]` {endash} Subnet name
* `--subnet-id xref:hammer-option-details-number[NUMBER]` {endash} Satellite subnet ID of IPv4 interface
* `--subnet6-id xref:hammer-option-details-number[NUMBER]` {endash} Satellite subnet ID of IPv6 interface
