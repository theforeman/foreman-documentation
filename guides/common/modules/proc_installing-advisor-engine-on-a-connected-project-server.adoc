[id="installing-advisor-engine-on-a-connected-project-server"]
...
ifndef::satellite[]
For more information, see https://podman.io/docs/installation#installing-on-linux[Installing on Linux].
endif::[]
