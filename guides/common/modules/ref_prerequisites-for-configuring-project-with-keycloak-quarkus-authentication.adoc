...
ifndef::orcharhino[]
For more information about configuring a different context path, see the https://docs.redhat.com/en/products/red_hat_build_of_keycloak/24.0/html-single/server_guide/index#reverseproxy-different-context-path-on-reverse-proxy[_{RHBK} Administration Guide_].
endif::[]
...
ifndef::orcharhino[]
For more information on importing or creating users, see the https://docs.redhat.com/en/products/red_hat_build_of_keycloak/24.0/html/server_administration_guide/user-storage-federation[_{RHBK} Administration Guide_].
endif::[]
