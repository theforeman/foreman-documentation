[[Managing_Container_Name_Patterns]]
...
. In the {ProjectWebUI}, navigate to *Content* > *Lifecycle Environments*, and either create a lifecycle environment or select a lifecycle environment to edit.
