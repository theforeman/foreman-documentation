...
. In the {ProjectWebUI}, navigate to *Content* > *Lifecycle* > *Lifecycle Environments*, and either create a lifecycle environment or select a lifecycle environment to edit.
