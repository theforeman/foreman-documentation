...
* {ContentManagementDocURL}adding-deb-repositories-by-using-web-ui[Adding Deb repositories in _{ContentManagementDocTitle}_]
* {ContentManagementDocURL}adding-custom-rpm-repositories-by-using-web-ui[Adding RPM repositories in _{ContentManagementDocTitle}_]
endif::[]
