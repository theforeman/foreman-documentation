...
PGbench utility (note you may need to resize PostgreSQL data directory `/var/lib/pgsql` directory to 100 GiB or what does benchmark take to run) might be used to measure PostgreSQL performance on your system.
