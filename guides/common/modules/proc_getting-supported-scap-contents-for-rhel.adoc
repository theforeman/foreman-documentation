...
[role="_abstract"]
You can obtain supported SCAP contents for RHEL by downloading the latest SCAP Security Guide (SSG) to match your RHEL minor version from the Red{nbsp}Hat Customer Portal.
