...
[role="_abstract"]
Import and manage Red{nbsp}Hat subscription manifests to access content from the Red{nbsp}Hat Content Delivery Network (CDN).
Subscription manifests enable {Project} to download and distribute Red{nbsp}Hat content to your organization's hosts.
