...
[role="_abstract"]
You can import content from the Red{nbsp}Hat Content Delivery Network (CDN) into your {ProjectServer} by using a Red{nbsp}Hat subscription manifest.
Manage your subscription allocations to ensure each organization can access and download the required repositories.
