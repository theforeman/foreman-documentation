...
[id="configuring-{project-context}-server-for-kvm-connections"]
...
.Procedure
. On your {ProjectServer}, switch to the `foreman` user:
+
----
...
.Verification
* On your {ProjectServer}, test the connection to the KVM server:
+
[options="nowrap"]
----
