...
. In the *Value* field, enter the URL or a relative path in the following format `custom/_product_/_repository_/_image_name.tar_` that points to the exact location where you store the image.
