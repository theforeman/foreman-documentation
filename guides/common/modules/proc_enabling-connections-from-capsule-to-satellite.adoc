...
For more information, see {InstallingProjectDocURL}Enabling_Connections_from_a_Client_to_Server_{project-context}[Enabling Connections from a Client to {ProjectServer}] in _{project-installation-guide-title}_.
