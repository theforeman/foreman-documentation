...
[id="selecting-an-installation-size"]
= Selecting an installation size
...
For more information, see xref:introduction-to-performance-tuning[].
. Optional: Refer to xref:puma-application-server-tunings[] to tune the Ruby app server directly.

[role="_additional-resources"]
.Additional resources
* {InstallingServerDocURL}tuning-{project-context}-server-performance-with-predefined-profiles[Tuning {ProjectServer} performance with predefined profiles in _{InstallingServerDocTitle}_]
