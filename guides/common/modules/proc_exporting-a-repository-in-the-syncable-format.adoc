...
[id="exporting-a-repository-in-the-syncable-format"]
...
* Download policy is set to *Immediate* for the repository within the Library lifecycle environment you export.
