...
. As an alternative to copying the ISO image content, you can mount the image to a directory such as `/mnt`,
. Create a symbolic link at `/var/www/html/pub/installation_media/ubuntu/22.04-x86_64` that points to the mounted image.
