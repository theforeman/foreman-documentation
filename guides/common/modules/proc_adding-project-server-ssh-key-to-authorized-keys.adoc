...
[role="_abstract"]
To run remote execution jobs on {ProjectServer} itself, add the {ProjectServer} SSH key to authorized keys on your {ProjectServer}.
...
Bug: https://projects.theforeman.org/issues/38965
////
