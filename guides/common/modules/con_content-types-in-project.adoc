...
[role="_abstract"]
You can import and manage various content types, such as packages and ISO images, in {ProjectName}.
ifdef::satellite[]
Organize both Red{nbsp}Hat and custom content into products to streamline your software distribution.
endif::[]
ifdef::katello,orcharhino[]
Organize content from Red{nbsp}Hat, Canonical, Oracle, SUSE, or any custom content into products to streamline your software distribution.
endif::[]
