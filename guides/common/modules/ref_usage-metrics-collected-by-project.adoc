...
[role="_abstract"]
You can review what usage metrics the `satellite-maintain report generate` command collects from your {Project} deployment.
The collected data includes information such as host counts, authentication sources, and content management statistics.
