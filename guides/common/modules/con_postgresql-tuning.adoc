...
The PostgreSQL authors recommend disabling Transparent Huge Pages on servers running PostgreSQL.
For more information, see xref:Disable_Transparent_Huge_Pages_{context}[].
