...
[role="_abstract"]
You can configure a {Project} user with the permissions required to run the bootstrap script from the {ProjectWebUI}.
This allows the user to register hosts with the script without granting full administrative access.
