...
[role="_abstract"]
{Project} provides templates for different host provisioning workflows.
Choose a provisioning template type based on your compute resource and provisioning environment.
