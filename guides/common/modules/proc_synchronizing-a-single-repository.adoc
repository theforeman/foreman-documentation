...
+
If you want to sync custom content, first xref:creating-a-custom-product-by-using-web-ui[create a custom product] and then xref:synchronizing-repositories-on-demand[synchronize product repositories].
