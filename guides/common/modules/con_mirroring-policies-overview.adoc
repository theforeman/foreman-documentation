...
[role="_abstract"]
Mirroring policies control whether synchronized repositories add only new content, mirror repodata, or fully mirror upstream changes including deletions.
Use them to match upstream behavior and storage needs for each repository.
