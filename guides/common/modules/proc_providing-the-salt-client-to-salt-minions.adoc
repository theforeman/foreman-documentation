...
For more information, see {ContentManagementDocURL}creating-a-custom-product-by-using-web-ui[Creating a product].
...
For more information, see {ContentManagementDocURL}creating-a-composite-content-view-by-using-web-ui[Create a composite content view].
...
For more information, see {ContentManagementDocURL}promoting-a-content-view-by-using-web-ui[Promoting a content view].
