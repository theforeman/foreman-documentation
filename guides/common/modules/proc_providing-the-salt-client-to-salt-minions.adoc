...
[id="providing-the-salt-client-to-salt-minions"]
...
* {ContentManagementDocURL}synchronizing-repositories-ad-hoc[Synchronizing repositories ad hoc]
* {ContentManagementDocURL}creating-a-content-view-by-using-web-ui[Creating a content view by using {ProjectWebUI}]
* {ContentManagementDocURL}creating-a-composite-content-view-by-using-web-ui[Create a composite content view by using {ProjectWebUI}]
* {ContentManagementDocURL}promoting-a-content-view-by-using-web-ui[Promoting a content view by using {ProjectWebUI}]
