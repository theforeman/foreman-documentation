...
+
Red Hat Enterprise Linux 9 for x86_64 - AppStream (RPMs):: `rhel-9-for-x86_64-appstream-rpms x86_64`
+
Red Hat Enterprise Linux 9 for x86_64 - BaseOS (RPMs):: `rhel-9-for-x86_64-baseos-rpms x86_64`
+
