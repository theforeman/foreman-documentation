...
[role="_abstract"]
Set default mirroring policies for new Yum and non-Yum custom repositories so they inherit additive, content-only, or complete mirroring without affecting existing repositories.
