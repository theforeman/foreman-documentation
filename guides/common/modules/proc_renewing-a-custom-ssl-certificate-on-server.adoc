...
[role="_abstract"]
You can deploy a renewed {customssl} certificate on {ProjectServer} to replace an expiring certificate and maintain trusted access to the {ProjectWebUI} and API.
