...
[role="_abstract"]
You can use Hammer CLI to create an activation key and configure content view environments, system purpose, and repository overrides for host registration.
