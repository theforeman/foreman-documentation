...
[role="_abstract"]
Assign content view environments to an activation key by using Hammer CLI so registered hosts receive content from the environments you specify, in the order you define.
