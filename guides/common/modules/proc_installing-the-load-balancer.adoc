...
----
. Configure the load balancer to balance the network load for the ports as described in xref:common/modules/proc_installing-the-load-balancer.adoc#ports-configuration-for-the-load-balancer[].
