...
----
# {foreman-maintain} packages install krb5-workstation oddjob-mkhomedir oddjob realmd samba-winbind-clients samba-winbind samba-common-tools samba-winbind-krb5-locator sssd
----
+
...
----
** Check that with the TGT, user authentication is successfully redirected:
+
[options="nowrap", subs="+quotes,verbatim,attributes"]
----
