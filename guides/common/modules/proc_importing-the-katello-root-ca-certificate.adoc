...
To use the CLI instead of the {ProjectWebUI}, see xref:common/modules/proc_importing-the-katello-root-ca-certificate.adoc#cli-importing-the-katello-root-ca-certificate[].
