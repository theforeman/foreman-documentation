...
[id="{ISS-id}-deployment-scenarios"]
= {ISS} deployment scenarios

[role="_abstract"]
You can use {ISS} to synchronize content between {ProjectServer}s, including air-gapped servers.
In these scenarios, you copy selected content views or all Library content from an upstream server to downstream servers over a network or through physical export.
...
image::iss-disconnected.png[title="{Project} ISS disconnected scenario", alt="{Project} ISS disconnected scenario"]
endif::[]
ifdef::satellite[]
image::iss-disconnected-satellite.png[title="{Project} ISS disconnected scenario", alt="{Project} ISS disconnected scenario"]
endif::[]
ifdef::orcharhino[]
image::iss-disconnected-orcharhino.svg[title="{Project} ISS disconnected scenario", alt="{Project} ISS disconnected scenario"]
endif::[]
...
ifndef::satellite,orcharhino[]
image::iss-airgapped.png[title="{Project} ISS air-gapped scenario", alt="The {Project} ISS air-gapped scenario"]
endif::[]
ifdef::satellite[]
image::iss-airgapped-satellite.png[title="{Project} ISS air-gapped scenario", alt="{Project} ISS air-gapped scenario"]
endif::[]
ifdef::orcharhino[]
image::iss-airgapped-orcharhino.svg[title="{Project} ISS air-gapped scenario", alt="{Project} ISS air-gapped scenario"]
endif::[]
...
ifndef::planning[]
ifdef::satellite[]
* xref:synchronize-content-between-satellite-servers-in-air-gapped-environments[]
* xref:synchronize-content-between-satellite-servers-over-a-network[]
endif::[]
endif::[]
