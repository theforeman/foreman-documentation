...
[role="_abstract"]
The oVirt platform is an enterprise-grade server and desktop virtualization platform.
In {ProjectName}, you can manage virtualization functions through the oVirt REST API.
