...
. Optional: xref:preparing-cloud-init-images-in-rhv_rhv-provisioning[].
Use this procedure if you want to use `cloud-init` to configure an image-based virtual machine.
. Optional: xref:adding-images-to-server_rhv-provisioning[].
Use this procedure if you want to use image-based provisioning.
. Optional: xref:preparing-a-cloud-init-template_rhv-provisioning[].
Use this procedure if you want to use `cloud-init` to configure an image-based virtual machine.
