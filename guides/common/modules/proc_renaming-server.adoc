...
ifndef::orcharhino[]
For more information about installing a custom SSL certificate, see {InstallingServerDocURL}deploying-a-custom-ssl-certificate-to-{project-context}-server[Deploying a custom SSL certificate to {ProjectServer}] in _{InstallingServerDocTitle}_.
endif::[]
