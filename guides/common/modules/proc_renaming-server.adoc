...
For more information about configuring external authentication, see link:{InstallingServerDocURL}Configuring_External_Authentication_{project-context}[Configuring external authentication].
