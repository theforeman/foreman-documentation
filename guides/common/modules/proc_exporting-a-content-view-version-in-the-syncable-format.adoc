...
[role="_abstract"]
You can export a content view version in syncable format to serve from a custom CDN over HTTP/HTTPS or import with Hammer CLI on a matching {Project} version.
