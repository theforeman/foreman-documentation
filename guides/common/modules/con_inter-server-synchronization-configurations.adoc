...
ifndef::satellite[]
* xref:configuring-{project-context}-server-to-synchronize-content-over-a-network-by-using-web-ui[]
* xref:configuring-{project-context}-server-to-synchronize-content-through-exports-by-using-web-ui[]
endif::[]
