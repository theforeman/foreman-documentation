...
[role="_abstract"]
Depending on network connectivity between upstream and downstream servers, you can synchronize content over HTTPS with network sync or by exporting and importing archives when servers are air gapped.
