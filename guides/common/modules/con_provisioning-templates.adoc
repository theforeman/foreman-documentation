...
ifdef::satellite[]
For more information, see {ContentManagementDocURL}Creating_an_Organization_Debug_Certificate_content-management[Creating an Organization Debug Certificate] in the _Content Management Guide_.
endif::[]
ifndef::satellite[]
