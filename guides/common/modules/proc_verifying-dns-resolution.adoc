...
ifdef::satellite[]
For more information, see {RHELDocsBaseURL}9/html-single/configuring_and_managing_networking/index#proc_changing-a-hostname-using-hostnamectl_assembly_changing-a-hostname[Changing a hostname using hostnamectl] in the _{RHEL} Configuring and managing networking_ guide.
endif::[]
