...
* {RHELDocsBaseURL}10/html-single/configuring_and_managing_networking/index#changing-a-hostname-using-hostnamectl[Changing a hostname using hostnamectl in _{RHEL}{nbsp}10 Configuring and managing networking_]
endif::[]
