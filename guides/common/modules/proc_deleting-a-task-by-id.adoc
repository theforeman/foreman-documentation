...
.Prerequisites
* Hammer is installed.
For more information, see link:https://docs.theforeman.org/nightly/Hammer_CLI/index-foreman-el.html#installing-standalone-hammer[_Installing Standalone Hammer_].
endif::[]
