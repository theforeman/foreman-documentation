...
ifdef::satellite[]
For more information, see {InstallingServerDisconnectedDocURL}configuring-{project-context}-server-to-synchronize-content-through-exports-by-using-web-ui[Configuring {ProjectServer} to synchronize content through exports by using {ProjectWebUI}] in _{InstallingServerDisconnectedDocTitle}_.
endif::[]
ifndef::satellite[]
