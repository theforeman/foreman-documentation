...
** If you use Puppet to manage host configurations, *{project-client-openvox}* for each {RHEL} version your clients are using
...
Add the *{project-client-openvox}* repository for the {RHEL} version your clients are using to the content views and publish and promote a new version of the content views.
...
* {ContentManagementDocURL}[Importing content in _{ContentManagementDocTitle}_]
