...
By default, the SCAP client is configured to ignore the remote resources, which causes the XCCDF rules that rely on the resources to be skipped and result in the `notchecked` status.
