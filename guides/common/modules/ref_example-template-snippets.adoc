...
[role="_abstract"]
Example template snippets show the correct ERB template syntax and common use cases.
You can use these snippets as a starting point when writing your own templates.
