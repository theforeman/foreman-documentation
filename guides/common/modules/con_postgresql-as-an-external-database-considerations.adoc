...
* Change the database setting when installing {Project}. For details, see {InstallingServerDocURL}configuring-dns-dhcp-and-tftp_{project-context}link:Configuring_Installation_{project-context}[Configuring {Project} installation]
