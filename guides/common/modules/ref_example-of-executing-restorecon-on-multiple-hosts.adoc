...
This example shows how to run a job based on the template created in xref:default-example-restorecon-template_{context}[] on multiple hosts. The job restores the SELinux context in all files under the */home/* directory.
