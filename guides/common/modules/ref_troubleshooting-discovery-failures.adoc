...
[id="troubleshooting-discovery-failures"]
...
For more information, see xref:prerequisites-for-using-discovery[].
...
* xref:customizing-the-discovery-pxe-boot[]
* xref:customizing-the-discovery-iso[]
