...
[role="_abstract"]
Add {customrpm} repositories from an upstream URL to distribute Yum content to your hosts.
Use Repo Discovery to import multiple repositories from one source.
