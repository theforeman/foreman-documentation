...
[role="_abstract"]
Add {customrpm} repository definitions in the {ProjectWebUI} so you can sync third-party or internal Yum sources into a product; use *Repo Discovery* to list every repo under one upstream URL and import several at once.
