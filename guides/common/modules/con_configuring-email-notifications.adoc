...
* {InstallingServerDocURL}Configuring_Server_for_Outgoing_Emails_{project-context}[Configuring {ProjectServer} for Outgoing Emails in _{InstallingServerDocTitle}_]
endif::[]
