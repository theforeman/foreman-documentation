...
[IMPORTANT]
====
In this scenario, the MCP server uses the Streamable HTTP transport mode for client-server communication.
Streamable HTTP is the default MCP transport mode that can in some cases represent potential security risks.
Consider using stdio transport mode instead.
