...
[role="_abstract"]
You can edit the system purpose attributes of multiple {RHEL} hosts at once from the {ProjectWebUI}.
Setting system purpose defines the intended use of the systems on your network and improves reporting accuracy in the Subscriptions service of the Red Hat Hybrid Cloud Console.
...
. Select the {RHEL} hosts that you want to edit.
