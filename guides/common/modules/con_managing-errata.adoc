...
[role="_abstract"]
Apply security, bugfix, and enhancement errata to your hosts to keep systems secure and up-to-date.
{Project} organizes errata from Red{nbsp}Hat, SUSE, and other vendors to enable targeted patching and compliance management.
