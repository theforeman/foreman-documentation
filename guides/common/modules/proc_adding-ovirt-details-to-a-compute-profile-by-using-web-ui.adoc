...
[role="_abstract"]
You can predefine certain hardware settings for virtual machines on oVirt.
...
.. From the *Preallocate disk* list, select either thin provisioning or preallocation of the full disk.
