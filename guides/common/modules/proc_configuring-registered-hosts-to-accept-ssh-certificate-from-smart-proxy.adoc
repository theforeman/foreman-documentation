...
[role="_abstract"]
You can configure hosts that were previously configured to use plain SSH keys to accept SSH certificates from the {SmartProxy} after you enable SSH certificate authentication on the {SmartProxy}.
...
. Import the CA public key to the host.
