...
[role="_abstract"]
After you enable SSH certificate authentication on your {SmartProxy}, you can configure hosts to accept SSH certificates from your {SmartProxy}.
...
Perform these steps on each host that uses your {SmartProxy} for remote execution and was registered before you enabled SSH certificate authentication on your {SmartProxy}.
