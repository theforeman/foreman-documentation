...
You can also set a custom validity period for the renewed certificates.
...
----
+
If you want to set a custom validity period, append `--certificate-validity-days _My_Days_` with the number of days the new certificates should remain valid.
