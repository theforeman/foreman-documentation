...
[role="_abstract"]
You can renew expired self-signed server and client certificates on {ProjectServer} to restore secure connections.
You can also specify a custom validity period instead of the default 7300 days.
