...
[id="performance-metrics-in-{project-context}"]
= Performance metrics in {Project}

[role="_abstract"]
Metrics help you monitor {Project} performance, plan capacity, and troubleshoot issues by collecting data on system resources, database activity, and application behavior.
