...
= Installing {insights-advisor} on a connected {ProjectServer}

You can pull the {insights-advisor} from the Red{nbsp}Hat container registry if your {ProjectServer} has access to the registry.
