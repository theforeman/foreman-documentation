...
[role="_abstract"]
You can manage content views in lifecycle environments in {ProjectName} by using Hammer CLI commands.
Control content promotion and version management across environments.
