...
[IMPORTANT]
====
Do not delete *Default Organization* created during installation because the default organization is a placeholder for any unassociated hosts in the {Project} environment.
