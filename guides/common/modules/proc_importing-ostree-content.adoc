...
.Procedure
. In the {ProjectWebUI}, navigate to *Content*{nbsp}>{nbsp}*Products* and click *Create Product*.
...
. To view the synchronization status, navigate to *Content*{nbsp}>{nbsp}*Sync Status* and expand the entry that you want to view.
