...
[role="_abstract"]
Export content view versions in a syncable format to create custom CDN mirrors or synchronize content across disconnected {ProjectServer}s.
Syncable exports enable both HTTP/HTTPS synchronization and direct import workflows.
