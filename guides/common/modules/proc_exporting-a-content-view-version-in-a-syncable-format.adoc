...
You can export a version of a Content View to a syncable format that you can use to create your custom CDN. Once exported you can either
* Synchronize the content from the custom CDN over HTTP/HTTPS.
* Import the content via `hammer content-import`  (Available if both the Export and Import servers are 6.13.0 and above.)
