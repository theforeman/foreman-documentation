...
[role="_abstract"]
You can view {Insights} recommendations for {RHEL} hosts in the {ProjectWebUI}.
Use the list to identify configuration issues and prioritize which recommendations to remediate.
