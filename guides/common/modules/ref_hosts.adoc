...
[role="_abstract"]
Use Hammer CLI commands to manage hosts, host groups, and remote job execution in {ProjectName}.
Create hosts, configure hosts by using host groups, and execute tasks remotely by using these commands.
