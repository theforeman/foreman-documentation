...
[role="_abstract"]
You can manage hosts, host groups, and remote job execution in {ProjectName} by using Hammer CLI commands.
Create hosts, configure hosts by using host groups, and execute tasks remotely.
