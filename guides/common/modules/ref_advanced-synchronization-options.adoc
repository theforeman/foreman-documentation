...
[id="advanced-synchronization-options"]
= Advanced synchronization options

[role="_abstract"]
Use advanced synchronization when standard synchronization leaves packages missing or corrupted on {ProjectServer}.
...
* xref:recovering-corrupted-content[]
