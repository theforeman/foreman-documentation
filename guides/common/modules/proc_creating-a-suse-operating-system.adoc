...
* {ProvisioningDocURL}_provisioning[Creating Operating Systems] in _{ProvisioningDocTitle}_
...
+
For more information, see {ProvisioningDocURL}creating-partition-tables-by-using-web-ui_provisioning[Partition Tables] in _{ProvisioningDocTitle}_.
