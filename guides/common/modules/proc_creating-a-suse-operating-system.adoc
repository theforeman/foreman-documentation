...
[role="_abstract"]
Create an installation medium and operating system entry for {SLES} to enable provisioning of SUSE hosts.
Operating system configuration integrates SUSE content into {Project}'s provisioning workflow.
...
* {ProvisioningDocURL}creating-operating-systems-by-using-web-ui[Creating operating systems by using {ProjectWebUI}] in _{ProvisioningDocTitle}_
