...
ifdef::katello[]
image::images/application_life_cycle.png[title="The {Project} Application Life Cycle", alt="The {Project} Application Life Cycle"]
endif::[]

ifdef::satellite[]
image::images/application_life_cycle_sat.png[title="The {Project} Application Life Cycle", alt="The {Project} Application Life Cycle"]
endif::[]

ifdef::orcharhino[]
image::images/application_life_cycle_orcharhino.svg[title="The {Project} Application Life Cycle", alt="The {Project} Application Life Cycle"]
endif::[]
