...
ifdef::katello[]
image::common/application_life_cycle.png[title="The {Project} Application Life Cycle", alt="The {Project} Application Life Cycle"]
endif::[]

ifdef::satellite[]
image::common/application_life_cycle_sat.png[title="The {Project} Application Life Cycle", alt="The {Project} Application Life Cycle"]
endif::[]

ifdef::orcharhino[]
image::common/application_life_cycle_orcharhino.svg[title="The {Project} Application Life Cycle", alt="The {Project} Application Life Cycle"]
endif::[]
