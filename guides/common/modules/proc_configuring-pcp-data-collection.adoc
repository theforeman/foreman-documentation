...
[id="configuring-pcp-data-collection"]
= Configuring PCP data collection

[role="_abstract"]
Configure PCP to collect detailed performance data from {Project} processes and services, such as Apache HTTP Server, PostgreSQL, and Redis to enable complete monitoring.
