...
You can set the default mirroring policy that {Project} applies to custom repositories that you create in all organizations.

Depending on whether it is a Yum or non-Yum custom repository, {Project} uses separate settings.
