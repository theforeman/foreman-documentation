...
.Procedure #1: Enrolling Sat Server as an IdM host
...
ifndef::satellite[]
For example, to add the {ProjectServer} system from the command line:
+
[options="nowrap", subs="+quotes,verbatim,attributes"]
----
# ipa host-add --random
----
// I don't think --random is what we should be recommending. TBD: Check `ipa help host`.
endif::[]
...
.Procedure #2: Configuring the ext provider
