...
For more information about installing and updating packages on {Project}, see link:{AdministeringDocURL}Managing_Packages_on_the_Base_Operating_System_{project-context}[Managing Packages on the Base Operating System of Satellite Server or Capsule Server].
====
endif::[]
+
[options="nowrap", subs="+quotes,verbatim,attributes"]
