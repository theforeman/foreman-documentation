...
[id="ansible-integration-settings"]
= Ansible integration settings

[role="_abstract"]
The Ansible settings define how {Project} integrates with Ansible for configuration management, including connection types, verbosity levels, timeout values, and role import behavior.
