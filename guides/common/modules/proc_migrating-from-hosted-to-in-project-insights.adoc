...
* If your {ProjectServer} is disconnected, ensure that the container images of {insights-iop} are available on your {ProjectServer}.
...
.Procedure
. If your {ProjectServer} is connected, log in to the Red{nbsp}Hat container registry:
+
