...
ifdef::satellite[]
[role="_abstract"]
Understand how {Project} groups Red Hat and custom sources into products and repositories so you can plan mirroring, subscriptions, and what hosts consume; a repository holds packages, images, or files, and a product bundles related repositories for lifecycle and access control.
endif::[]
ifndef::satellite[]
[role="_abstract"]
Understand how {Project} groups upstream, vendor, and custom sources into products and repositories so you can plan mirroring and what diverse clients consume; a repository holds packages, images, or files, and a product bundles related repositories for lifecycle and access control.
endif::[]
