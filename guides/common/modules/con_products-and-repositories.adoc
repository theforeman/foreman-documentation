...
[id="products-and-repositories"]
= Products and repositories in {Project}

[role="_abstract"]
Products group related repositories in {Project}.
Each repository stores packages or other content that you synchronize from upstream or upload directly.
...
ifdef::satellite[]
* {RHELDocsBaseURL}10/html/packaging_and_distributing_software/index[_Packaging and distributing software_ in {RHEL}{nbsp}10 documentation]
endif::[]
