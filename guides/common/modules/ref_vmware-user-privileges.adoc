...
[role="_abstract"]
VMware vSphere requires an administration-like user for {ProjectServer} communication.
For security, create a dedicated user with required privileges instead of using the `administrator` account.
