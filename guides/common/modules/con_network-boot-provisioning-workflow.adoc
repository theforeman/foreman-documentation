...
To destroy the VM when deleting the host entry on {Project}, navigate to *Administer*{nbsp}>{nbsp}*Settings* > *Provisioning* and configure this behavior using the *destroy_vm_on_host_delete* setting.
