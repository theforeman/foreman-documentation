...
[id="adding-a-microsoft-azure-connection-by-using-web-ui_{context}"]
= Adding a Microsoft Azure Resource Manager connection to {ProjectServer} by using {ProjectWebUI}
