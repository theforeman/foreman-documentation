...
ifdef::satellite[]
|Actions Remote Execution Run Host Job Ansible Run Red{nbsp}hat Lightspeed Plan Succeeded |Runs a given maintenance plan from Red Hat Access Red{nbsp}Hat Lightspeed given an ID.|Actions::RemoteExecution::RunHostJob
endif::[]
