...
[role="_abstract"]
Deploy SSH keys added to a user during provisioning to establish secure, passwordless remote access (SSH) to your newly provisioned hosts immediately after the installation.
