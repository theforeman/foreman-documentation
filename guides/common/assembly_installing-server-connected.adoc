...
For more information on subscription manifests, see {ContentManagementDocURL}Managing_Red_Hat_Subscriptions_content-management[Managing Red Hat Subscriptions] in the _Content Management Guide_.
endif::[]
