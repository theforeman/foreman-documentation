...
:InstallingServerDocTitle: Installing Foreman {ProjectVersion} Server with Katello {KatelloVersion} Plugin on {OSBaseTitle}
:QuickstartDocTitle: Quickstart Guide for {Project} with Katello on {OSBaseTitle}
