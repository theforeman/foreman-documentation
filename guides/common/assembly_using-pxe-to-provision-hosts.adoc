...
:secureboot-os-name: _My_Operating_System_In_Lowercase_
:secureboot-os-version: _My_Operating_System_Version_
:secureboot-os-architecture: _My_Architecture_"
...
include::modules/proc_configuring-server-to-provision-secure-boot-enabled-hosts.adoc[leveloffset=+1]
