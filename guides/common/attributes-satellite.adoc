...
:ManagingConfigurationsAnsibleDocURL: {BaseURL}managing_configurations_using_ansible_integration/index#
...
:keycloak-wildfly: Red{nbsp}Hat Single Sign-On
:keycloak-quarkus: Red{nbsp}Hat build of Keycloak
:keycloak: {keycloak-quarkus} or {keycloak-wildfly}
...
:project-client-el7-url: {RepoRHEL7ServerSatelliteToolsProjectVersion}
:project-client-el8-url: {RepoRHEL8ServerSatelliteToolsProjectVersion}
