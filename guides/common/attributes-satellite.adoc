...
:InstallingServerDocURL: {BaseURL}installing_satellite_server_from_a_connected_network/index#
:InstallingServerDisconnectedDocURL: {BaseURL}installing_satellite_server_from_a_disconnected_network/index#
...
:ReleaseNotesURL: https://access.redhat.com/documentation/en-us/red_hat_satellite/{ProjectVersion}/html/release_notes/index#
