...
:InstallingProjectDocURL: {BaseURL}installing_satellite_server_in_a_connected_network_environment/index#
...
=======
// Titles overrides
:InstallingServerDocTitle: Installing {ProjectServerTitle} from a Connected Network
:InstallingServerDisconnectedDocTitle: Installing {ProjectServerTitle} from a Disconnected Network
:ManagingConfigurationsPuppetDocTitle: Managing Configurations Using Puppet Integration in {ProjectName}
>>>>>>> a9625234e... Override titles per product
