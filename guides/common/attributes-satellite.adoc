...
ifdef::containerized[:installer-log-file: /var/log/foremanctl/foremanctl.log]
ifndef::containerized[:installer-log-file: /var/log/foreman-installer/satellite.log]
