...
:install-on-os: RHEL
:ProjectVersion: 6.20
:ProjectVersionPrevious: 6.19
:ProjectVersionPrevious-Previous: 6.18
...
:customrepos: custom repositories
:customreposid: custom-repositories
:customrpm: custom RPM
:DocState: satellite
:EL: {RHEL}
:EL-id: red-hat-enterprise-linux
:EL-abbr: RHEL
:fdi-package-name: foreman-discovery-image
:foreman-example-com: satellite.example.com
:foremanctl: satellitectl
:foremanctl_initial_deploy_opts: {sp}--flavor satellite
...
:ISS-id: inter-satellite-synchronization
...
:KubeVirt-id: openshift-virtualization
:a-KubeVirt: an OpenShift Virtualization
:a-KubeVirt-id: an-openshift-virtualization
:kubevirt-command: oc
...
:OpenStack-id: red-hat-openstack-services-on-openshift
...
:project-server-context: satellite-server
...
:smart-proxies-context: capsules
...
:RepoRHEL10SatelliteVersion: satellite-{RepoSatelliteVersion}-for-rhel-10-x86_64-rpms
...
:foremanctl-proxy-scenario: capsule
:project-installer-package: satellitectl
:smartproxy-installer-package: satellitectl
