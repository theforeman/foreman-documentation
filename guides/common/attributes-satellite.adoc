...
// For beta
:RepoSatelliteVersion: 7-beta
:BaseServerRepoID: server-7
// For a release
:RepoSatelliteVersion: {ProductVersion}
:BaseServerRepoID: 7-server

:RepoRHEL7ServerSatelliteServerProductVersion: rhel-{BaseServerRepoID}-satellite-{RepoSatelliteVersion}-rpms
:RepoRHEL8ServerSatelliteServerProductVersion: satellite-{RepoSatelliteVersion}-for-rhel-8-x86_64-rpms
:RepoRHEL7ServerSatelliteServerProductVersionPrevious: rhel-{BaseServerRepoID}-satellite-{ProductVersionPrevious}-rpms
...
:RepoRHEL7ServerSatelliteMaintenanceProductVersion: rhel-{BaseServerRepoID}-satellite-maintenance-{RepoSatelliteVersion}-rpms
