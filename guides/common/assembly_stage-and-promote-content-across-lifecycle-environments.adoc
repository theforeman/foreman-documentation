include::modules/con_stage-and-promote-content-across-lifecycle-environments.adoc[]
...
include::modules/proc_creating-a-lifecycle-environment-path-by-using-web-ui.adoc[leveloffset=+1]
