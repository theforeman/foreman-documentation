...
include::modules/proc_adding-an-ovirt-connection-to-project-server-by-using-web-ui.adoc[leveloffset=+1]

include::modules/proc_adding-an-ovirt-connection-to-project-server-by-using-cli.adoc[leveloffset=+1]
