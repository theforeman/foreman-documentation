...
include::assembly_removing-a-host-from-server.adoc[leveloffset=+1]

include::modules/proc_removing-a-host-from-server-intro.adoc[leveloffset=+1]

include::modules/proc_removing-a-host-from-server-addresources.adoc[leveloffset=+1]
