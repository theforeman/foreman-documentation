...
include::modules/proc_configuring-smart-proxy-to-provision-client-os-by-using-uefi.adoc[leveloffset=+2]
endif::[]
...
ifdef::satellite[]
include::modules/proc_configuring-smart-proxy-to-provision-client-os-by-using-uefi.adoc[leveloffset=+1]
endif::[]
