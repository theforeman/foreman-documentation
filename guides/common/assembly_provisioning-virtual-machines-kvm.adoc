...
** *view_subnets*
+
For more information about creating roles, see {AdministeringDocURL}creating-a-role_admin[Creating a Role] in the _Administering {ProjectName}_ guide. For more information about adding permissions to a role, see {AdministeringDocURL}adding-permissions-to-a-role_admin[Adding Permissions to a Role] in the _Administering {ProjectName}_ guide.
