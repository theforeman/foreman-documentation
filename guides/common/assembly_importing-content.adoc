...
<<<<<<< HEAD
<<<<<<< HEAD
include::modules/proc_restricting-custom-repositories-to-RHEL-9.adoc[leveloffset=+1]
=======
include::modules/con_repository-sets.adoc[leveloffset=+1]
>>>>>>> 2527bd0e3 (Added a module in Section 5 for Importing Content at the end of Section 5 called Repository sets)
=======
include::modules/proc_repository-sets.adoc[leveloffset=+1]
>>>>>>> c7772a276 (New feature for Repository sets was added as a prcudure module in the Content Management Guide in Section 5 Importing Content. This is related to SATDOC-523 in Jira. Originally this was created as a concept module but after the inital PR, it was suggested to change to a procedure module and to be reformatted to IBM style better.)
