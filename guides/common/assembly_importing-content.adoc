...
include::modules/proc_importing-custom-ssl-certificates-by-using-web-ui.adoc[leveloffset=+1]

include::modules/proc_importing-custom-ssl-certificates-by-using-cli.adoc[leveloffset=+1]

include::modules/proc_creating-a-custom-product-by-using-web-ui.adoc[leveloffset=+1]

include::modules/proc_creating-a-custom-product-by-using-cli.adoc[leveloffset=+1]

include::modules/proc_adding-custom-rpm-repositories-by-using-web-ui.adoc[leveloffset=+1]
...
include::modules/proc_adding-custom-deb-repositories-by-using-web-ui.adoc[leveloffset=+1]

include::modules/proc_adding-custom-deb-repositories-by-using-cli.adoc[leveloffset=+1]
...
include::modules/con_repository-synchronization.adoc[leveloffset=+1]
...
include::modules/proc_uploading-content-to-custom-rpm-repositories-by-using-web-ui.adoc[leveloffset=+1]
...
include::modules/con_advanced-synchronization-for-repository-recovery.adoc[leveloffset=+1]

include::modules/proc_recovering-a-corrupted-repository-by-using-web-ui.adoc[leveloffset=+2]

include::modules/proc_recovering-a-corrupted-repository-by-using-cli.adoc[leveloffset=+2]
...
include::modules/proc_adding-an-http-proxy-by-using-web-ui.adoc[leveloffset=+1]

include::modules/proc_adding-an-http-proxy-by-using-cli.adoc[leveloffset=+1]

include::modules/proc_changing-the-http-proxy-policy-for-a-product.adoc[leveloffset=+1]

include::modules/proc_changing-the-http-proxy-policy-for-a-repository-by-using-web-ui.adoc[leveloffset=+1]

include::modules/proc_changing-the-http-proxy-policy-for-a-repository-by-using-cli.adoc[leveloffset=+1]

include::modules/proc_creating-a-sync-plan-by-using-web-ui.adoc[leveloffset=+1]

include::modules/proc_creating-a-sync-plan-by-using-cli.adoc[leveloffset=+1]

include::modules/proc_assigning-a-sync-plan-to-a-product-by-using-web-ui.adoc[leveloffset=+1]

include::modules/proc_assigning-a-sync-plan-to-a-product-by-using-cli.adoc[leveloffset=+1]
...
include::modules/proc_importing-a-custom-gpg-key-by-using-web-ui.adoc[leveloffset=+1]

include::modules/proc_importing-a-custom-gpg-key-by-using-cli.adoc[leveloffset=+1]
