...
[id="provisioning-cloud-instances-in-azure"]
...
ifeval::["{build}" == "foreman"]
include::modules/installing-the-azurerm-plugin.adoc[leveloffset=+1]
endif::[]

include::modules/adding-azure-connection.adoc[leveloffset=+1]

include::modules/proc_adding-images-to-server.adoc[leveloffset=+1]

include::modules/adding-azure-details-to-a-compute-profile.adoc[leveloffset=+1]
