...
include::modules/proc_configuring-the-fallback-to-any-smartproxy-remote-execution-setting-in-project-by-using-web-ui.adoc[leveloffset=+1]

include::modules/proc_configuring-the-fallback-to-any-smartproxy-remote-execution-setting-in-project-by-using-cli.adoc[leveloffset=+1]

include::modules/proc_configuring-the-global-smartproxy-remote-execution-setting-in-project-by-using-web-ui.adoc[leveloffset=+1]

include::modules/proc_configuring-the-global-smartproxy-remote-execution-setting-in-project-by-using-cli.adoc[leveloffset=+1]
