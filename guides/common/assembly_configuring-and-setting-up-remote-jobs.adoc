...
ifndef::satellite[]
:parent_client_template_type: {client_template_type}
:client_template_type: AutoYaST
include::modules/proc_configuring-a-template-to-distribute-ssh-keys-during-provisioning.adoc[leveloffset=+1]
:client_template_type: {parent_client_template_type}
endif::[]
