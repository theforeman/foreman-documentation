...
include::modules/ref_planning-project-server-and-smart-proxy-server-backup.adoc[leveloffset=+1]

ifdef::katello,orcharhino,satellite[]
include::modules/proc_estimating-the-size-of-a-backup.adoc[leveloffset=+1]
endif::[]

include::modules/con_offline-backup-and-online-backup.adoc[leveloffset=+1]

include::modules/con_directories-created-during-backups.adoc[leveloffset=+1]
