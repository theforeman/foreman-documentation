...
include::common/assembly_provisioning-virtual-machines-kubevirt.adoc[leveloffset=+

include::common/modules/proc_using-novnc-to-access-virtual-machines.adoc[leveloffset=+1]1]
