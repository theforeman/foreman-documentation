...
include::common/assembly_configuring-single-sign-on-and-two-factor-authentication-with-keycloak-wildfly-in-project.adoc[leveloffset=+1]
...
include::common/assembly_configuring-kerberos-single-sign-on-for-active-directory-users-in-project.adoc[leveloffset=+1]
