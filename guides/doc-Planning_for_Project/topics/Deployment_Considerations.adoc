...
* For more information about installing {ProjectServer} from a connected network, see {InstallingProjectDocURL}[_{InstallingServerDocTitle}_] and {InstallingProjectDocURL}Preparing_your_Environment_for_Installation_{project-context}[Preparing your Environment for Installation] in the same guide.
+
...
For more information about using an external database, see {InstallingProjectDocURL}using-external-databases_{project-context}[Using External Databases with {Project}] in _{InstallingServerDocTitle}_.
