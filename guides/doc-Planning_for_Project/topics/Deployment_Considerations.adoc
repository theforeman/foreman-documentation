...
+
image::life-cycle-path-basic-satellite.png[A single lifecycle environment]
...
+
image::life-cycle-path-simple-satellite.png[A single lifecycle environment path]
...
+
image::life-cycle-path-diverged-satellite.png[Application specific lifecycle environment paths]
