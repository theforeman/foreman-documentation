...
For more information, see {BaseURL}administering_red_hat_satellite/searching_and_bookmarking_admin#Building_Search_Queries_admin[Building Search Queries] in _Administering {ProjectName}_.
