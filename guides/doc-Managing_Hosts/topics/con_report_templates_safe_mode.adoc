[[con_report_templates_safe_mode]]
...
The list of supported macros and variables is available in the {Project} web UI.

To view the macros and variables that are available, in the {Project} web UI, navigate to *Monitor* > *Report Templates* and click *Create Template*.
...
To view the status of safe mode in {Project}, in the {Project} web UI, navigate to *Administer* > *Settings* and click the *Provisioning* tab.
