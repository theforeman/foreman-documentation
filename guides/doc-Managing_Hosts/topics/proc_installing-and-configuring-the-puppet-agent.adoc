...
Use this procedure to install and configure the Puppet agent on a host. For more information about Puppet, see the link:{BaseURL}puppet_guide/[_Puppet Guide_].
