[[proc_creating_a_report_table_to_monitor_entitlements]]
...
For more information about writing templates, see xref:appe-Managing_Hosts-Template_Writing_Reference[].
