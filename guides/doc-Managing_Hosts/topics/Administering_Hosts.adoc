...
For general information about organizations and how to configure them, see {BaseURL}content_management_guide/managing_organizations[Managing Organizations] in the _Content Management Guide_.
...
For general information about locations and how to configure them, see {BaseURL}content_management_guide/managing_locations#Managing_Locations-Creating_a_Location[Creating a Location] in the _Content Management Guide_.
