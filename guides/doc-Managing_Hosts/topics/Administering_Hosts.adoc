...
include::../common/modules/proc_cloning-hosts.adoc[leveloffset=+1]
...
For general information about locations and how to configure them, see {ContentManagementDocURL}Creating_a_Location_content-management[Creating a Location] in the _Content Management Guide_.
