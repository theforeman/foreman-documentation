[[sect-Managing_Hosts-Adding_Packages_to_a_Host_Collection]]
= Adding Packages to a Host Collection

The following procedure shows how to add packages to host collections.

[[form-Managing_Hosts-Adding_Packages_to_a_Host_Collection-Task_Prerequisites]]
.Prerequisites
...
[[proc-Managing_Hosts-Adding_Packages_to_a_Host_Collection-To_Add_Packages_to_Host_Collections]]
.Procedure
