...
+
WARNING: Until https://bugzilla.redhat.com/show_bug.cgi?id=1850994[BZ#1850994] is resolved, if your host is installed on RHV version 4.4 or lower, do not remove the `katello-agent` package because the removed dependencies corrupt the host.
+
