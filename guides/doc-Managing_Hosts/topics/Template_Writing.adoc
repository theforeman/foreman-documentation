...
For more information, see link:{BaseURL}provisioning_guide/configuring_provisioning_resources#creating-provisioning-templates_provisioning[Creating Provisioning Templates] in the _Provisioning Guide_.
...
For more information, see link:{BaseURL}provisioning_guide/configuring_provisioning_resources#creating-partition-tables_provisioning[Creating Partition Tables] in the _Provisioning Guide_.
