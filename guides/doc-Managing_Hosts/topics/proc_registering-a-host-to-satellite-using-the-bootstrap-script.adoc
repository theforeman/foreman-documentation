...
----
+
Alternatively, you can create a new user and assign this new role to them. For more information on creating users with Hammer, see {AdministeringDocURL}chap-Red_Hat_Satellite-Administering_Red_Hat_Satellite-Users_and_Roles[Managing Users and Roles] in the _Administering {ProjectName}_ guide.
