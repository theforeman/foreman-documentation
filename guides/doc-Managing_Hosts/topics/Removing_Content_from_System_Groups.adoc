[[sect-Managing_Hosts-Removing_Content_from_a_Host_Collection]]
= Removing Content from a Host Collection

The following procedure shows how to remove packages from host collections.

[[proc-Managing_Hosts-Removing_Content_from_a_Host_Collection-To_Remove_Content_from_a_Host_Collection]]
