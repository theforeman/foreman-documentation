...
* Satellite or Capsule can authenticate to the host with SSH keys. For more information, xref:sect-Managing_Hosts-Establishing_a_Secure_Connection_for_Remote_Commands[].
