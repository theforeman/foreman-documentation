...
For more information about using the {Project} API, see the https://access.redhat.com/documentation/en-us/red_hat_satellite/{ProductVersion}/html/api_guide/index[API Guide].
