[[proc_exporting_report_templates_api]]
= Exporting Report Templates Using the Satellite API

You can use the Satellite `report_templates` API to export report templates from Satellite. For more information about using the Satellite API, see the https://access.redhat.com/documentation/en-us/red_hat_satellite/{ProductVersion}/html/api_guide/index[API Guide].
