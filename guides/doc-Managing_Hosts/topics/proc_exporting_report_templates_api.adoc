...
You can use the {Project} `report_templates` API to export report templates from {Project}. For more information about using the {Project} API, see the https://access.redhat.com/documentation/en-us/red_hat_satellite/{ProductVersion}/html/api_guide/index[API Guide].
