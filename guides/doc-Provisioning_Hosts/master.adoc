...
include::common/assembly_preparing-networking-for-host-management.adoc[leveloffset=+1]
...
ifndef::satellite[]
include::common/assembly_provisioning-virtual-machines-ovirt.adoc[leveloffset=+1]
endif::[]
...
ifndef::satellite[]
include::common/assembly_provision-hosts-through-opentofu.adoc[leveloffset=+1]
endif::[]
...
ifdef::satellite[]
[appendix]
include::common/assembly_building-cloud-images-for-project.adoc[leveloffset=+1]
endif::[]
...
[appendix]
include::common/assembly_bootloader-binary-location.adoc[leveloffset=+1]
