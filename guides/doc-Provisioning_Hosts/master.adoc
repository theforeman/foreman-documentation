...
include::common/modules/proc_provisioning-from-a-builder-image-on-project-server.adoc[leveloffset=+2]
...
include::common/modules/proc_provisioning-from-a-builder-image-on-an-http-server.adoc[leveloffset=+1]
endif::[]
