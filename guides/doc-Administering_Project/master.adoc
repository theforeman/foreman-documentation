...
include::common/assembly_cleaning-audit-records.adoc[leveloffset=+1]

include::common/assembly_cleaning-report-records.adoc[leveloffset=+1]

include::common/assembly_cleaning-task-records.adoc[leveloffset=+1]

ifndef::foreman-deb[]
include::common/assembly_reclaiming-disk-space.adoc[leveloffset=+1]
endif::[]
