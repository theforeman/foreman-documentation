...
include::common/assembly_managing-audit-records.adoc[leveloffset=+1]

include::common/assembly_deleting-report-records.adoc[leveloffset=+1]

include::common/assembly_managing-task-records.adoc[leveloffset=+1]
