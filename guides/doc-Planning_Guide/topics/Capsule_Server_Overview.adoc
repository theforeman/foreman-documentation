...
The {InstallingProjectDocURL}satellite-ports-and-firewalls-requirements_{project-context}[Ports and Firewalls Requirements] in _{project-installation-guide-title}_,
ifdef::satellite[]
https://access.redhat.com/documentation/en-us/red_hat_satellite/{AccessRedHatComVersion}/html/installing_satellite_server_from_a_disconnected_network/preparing-environment-for-satellite-installation#satellite-ports-and-firewalls-requirements_{project-context}[Ports and Firewalls Requirements]
endif::[]
ifndef::satellite[]
{InstallingProjectDisconnectedDocUrl}satellite-ports-and-firewalls-requirements_{project-context}[Ports and Firewalls Requirements]
endif::[]
in _Installing {ProjectServer} from a Disconnected Network_ and {InstallingSmartProxyDocURL}capsule-ports-and-firewalls-requirements_{smart-proxy-context}[Ports and Firewalls Requirements] in _{smart-proxy-installation-guide-title}_ contain complete instructions for configuring the host-based firewall to open the ports required.
