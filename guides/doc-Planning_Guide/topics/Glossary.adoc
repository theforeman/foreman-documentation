...
*Discovery Image*:: Refers to the minimal operating system based on {RHEL} is PXE-booted on hosts to acquire initial hardware information and to communicate with {ProjectServer} before starting the provisioning process.
