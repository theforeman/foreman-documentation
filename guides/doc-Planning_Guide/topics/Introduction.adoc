...
[[sect-Architecture_Guide-Introduction_to_Red_Hat_Satellite-Red_Hat_Satellite_6_System_Architecture]]
=== System Architecture
...
[[figu-Architecture_System_Architecture-Red_Hat_Satellite_6_System_Architecture]]
