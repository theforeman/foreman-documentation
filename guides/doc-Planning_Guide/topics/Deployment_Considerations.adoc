...
Find instructions on defining roles and assigning them to users in {BaseURL}administering_red_hat_satellite/[_Administering {ProjectName}_]. The same guide contains information on configuring external authentication sources.
