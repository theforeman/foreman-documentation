...
For more information about using an external database, see {InstallingProjectDocURL}performing-additional-configuration#using-external-databases_satellite[Using External Databases with {Project}] in _{project-installation-guide-title}_.
