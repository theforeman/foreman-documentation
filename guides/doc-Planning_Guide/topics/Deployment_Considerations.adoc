...
.Adding {Project} Red{nbsp}Hat Subscription Manifests to {ProjectServer}
...
For instructions on how to create and import a Red{nbsp}Hat Subscription Manifest see {ContentManagementDocURL}Managing_Subscriptions_content-management[Managing Red Hat Subscriptions] in the _Content Management Guide_.
