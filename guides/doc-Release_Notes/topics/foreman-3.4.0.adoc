...
=== Host index page columns

* Since https://projects.theforeman.org/issues/35361[#35361] customizing hosts table using Deface will not work. Please use the pagelets DSL to add custom columns.