...
* pass:[Host::Managed audit exclusions not applied, resulting in excessive audit records in Foreman] - https://projects.theforeman.org/issues/39591[#39591]
...
* pass:[Support Rack 3 and Sinatra 4] - https://projects.theforeman.org/issues/38120[#38120]
