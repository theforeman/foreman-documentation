...
include::topics/foreman-3.18.2.adoc[leveloffset=+1]
include::topics/foreman-3.18.1.adoc[leveloffset=+1]
include::topics/foreman-3.18.0.adoc[leveloffset=+1]
ifdef::katello[]
include::topics/katello-4.20.1.adoc[leveloffset=+1]
include::topics/katello-4.20.0.adoc[leveloffset=+1]
endif::[]
