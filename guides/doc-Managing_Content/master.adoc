...
include::common/assembly_getting-started-with-content-management.adoc[leveloffset=+1]
endif::[]
...
ifdef::katello,satellite,orcharhino[]
include::common/assembly_optimize-content-synchronization-for-bandwidth.adoc[leveloffset=+1]
endif::[]
