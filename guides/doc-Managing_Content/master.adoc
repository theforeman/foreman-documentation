...
include::common/assembly_configuring-content-view-filters.adoc[leveloffset=+1]

include::common/assembly_using-rolling-content-views.adoc[leveloffset=+1]

include::common/assembly_using-composite-content-views.adoc[leveloffset=+1]

include::common/assembly_managing-content-view-versions.adoc[leveloffset=+1]
