...
ifndef::satellite[]
include::snip_katello-only.adoc[]
endif::[]
...
For more information about updating packages in {Project}, see {UpgradingDocURL}updating_satellite_server_to_next_minor_version[Updating {ProjectServer}].
