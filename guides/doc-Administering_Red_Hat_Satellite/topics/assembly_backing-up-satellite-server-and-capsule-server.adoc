...
== Backing Up Satellite Server and Capsule Server

You can back up your Satellite deployment to ensure the continuity of your Red{nbsp}Hat Satellite deployment and associated data in the event of a disaster.
...
Satellite services are unavailable during the backup.
