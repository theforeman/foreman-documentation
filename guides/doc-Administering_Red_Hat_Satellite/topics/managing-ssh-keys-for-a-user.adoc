...
.Prerequisites
Make sure that you are logged in to the web UI as an Admin user of Red{nbsp}Hat Satellite or a user with the __create_ssh_key__ permission enabled for adding SSH key and __destroy_ssh_key__ permission for removing a key.
