[[sect-Administering-Using_LDAP]]
=== Using LDAP

{Project} supports LDAP authentication using one or multiple LDAP directories.

[[sect-Administering-Using_Configuring_TLS_for_Secure-LDAP]]
...
[[sect-Administering-Using_Configuring_Red_Hat_Satellite_to_Use_LDAP]]

include::configuring-red-hat-satellite-to-use-ldap.adoc[leveloffset=+3]

[[sect-Administering-LDAP_Settings]]
