...
[[sect-Administering-Backup_and_Disaster_Recovery-Backing_up_and_Restoring_Capsule_Server_Using_a_Virtual_Machine_Snapshot]]

include::backup-and-restore-capsule-server-using-a-virtual-machine-snapshot.adoc[leveloffset=2]

[[proc-Administering-Synchronizing_an_External_Capsule]]
