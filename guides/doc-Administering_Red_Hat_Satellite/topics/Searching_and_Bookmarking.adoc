...
To learn how free text is interpreted by the search engine, see xref:sect-{Project_Link}-Administering_{Project_Link}-Searching_and_Bookmarking-Using_Free_Text_Search[].
...
For a list of all operators, see xref:sect-{Project_Link}-Administering_{Project_Link}-Operators[Operators].
For descriptions of value formats, see xref:sect-{Project_Link}-Administering_{Project_Link}-Values[Values].
