...
For more information, see {InstallingSmartProxyDocURL}enabling-openscap_{smart-proxy-context}[Enabling OpenSCAP on External {SmartProxies}] in the _Installing {SmartProxyServer}_ guide.
