...
If using an external authentication source, you can map {Project} user groups to external user groups as described in xref:sect-{Project_Link}-Administering_{Project_Link}-Creating_User_Groups-Configuring_External_User_Groups[].
