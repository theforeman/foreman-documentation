...
:toc:
:toc-placement: left
:BaseURL: https://docs.theforeman.org/master/Managing_Hosts/index-foreman.html#
endif::[]

ifeval::["{build}" == "satellite"]
:BaseURL: https://access.redhat.com/documentation/en-us/red_hat_satellite/6.8/html-single/managing_hosts/index#
endif::[]
