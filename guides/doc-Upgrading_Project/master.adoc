...
ifndef::foreman-deb[]
include::common/modules/con_upgrading-project-or-proxy-from-el8to9.adoc[leveloffset=+1]

// Migrating to RHEL9
include::common/modules/proc_migrating-project-or-smartproxy-using-backup.adoc[leveloffset=+2]
endif::[]
endif::[]
