...
* Ensure that you synchronize the following repositories on {ProjectServer}:
ifdef::satellite[]
** {RepoRHEL8BaseOS}
** {RepoRHEL8AppStream}
...
** {EL} 8 BaseOS
** {EL} 8 AppStream
** ??? what is the Utils alternative for Foreman/Katello?
endif::[]
...
ifndef::satellite[]
??? is there an alternative for Foreman/Katello?
endif::[]
...
----
. Install Hammer Ruby gem:
+
[options="nowrap" subs="verbatim,quotes,attributes"]
----
# {client-package-install-el8} rubygem-hammer_cli_katello
----
+
