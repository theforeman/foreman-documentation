...
include::common/modules/proc_updating-disconnected-server-on-EL8.adoc[leveloffset=+2]
include::common/modules/proc_updating-disconnected-server-on-EL8-EUS.adoc[leveloffset=+2]
include::common/modules/proc_updating-disconnected-server-on-EL9.adoc[leveloffset=+2]
include::common/modules/proc_updating-disconnected-server-on-EL9-EUS.adoc[leveloffset=+2]
endif::[]
