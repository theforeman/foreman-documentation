...
include::common/modules/proc_editing-a-virt-who-configuration-by-using-web-ui.adoc[leveloffset=+1]

include::common/modules/proc_editing-a-virt-who-configuration-by-using-cli.adoc[leveloffset=+1]
