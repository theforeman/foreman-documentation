...
To upgrade {SmartProxyServer}s from {ProductVersionPrevious} to {ProductVersion}, complete the link:{BaseURL}upgrading_and_updating_red_hat_satellite/upgrading_red_hat_satellite#upgrading_capsule_server[Upgrading {SmartProxyServer}s] procedure in _Upgrading and Updating {ProjectName}_.
endif::[]
