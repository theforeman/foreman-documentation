...
For more information, see {AdministeringDocURL}sect-Administering-Security_Compliance_Management_with_OpenSCAP-Configuring_SCAP_Content[Configuring SCAP Content] in _Administering {ProjectName}_.
