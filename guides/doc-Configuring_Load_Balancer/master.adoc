...
include::common/assembly_configuring-smartproxyservers-with-custom-ssl-certificates-for-load-balancing.adoc[leveloffset=+1]

include::common/assembly_configuring-smartproxyservers-with-default-ssl-certificates-for-load-balancing.adoc[leveloffset=+1]
