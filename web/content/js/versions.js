const navVersions = [
  ...
  {
    "title": "Foreman 3.11 - Katello 4.13 (RC)",
    "path": "3.11",
    "builds": [
      {
        "title": "Foreman on EL",
      ...
      },
      {
        ...
        "guides": [
          ...
          {
            "title": "Upgrading Katello to 4.13",
            "path": "Upgrading_Project"
          },
          {
            "title": "Tuning Performance",
    ...
    "builds": [
      {
        ...
        "guides": [
          ...
          {
            "title": "Upgrading Foreman to 3.10",
            "path": "Upgrading_Project"
          },
          {
            "title": "Configuring Hosts Using Ansible",
      ...
      },
      {
        ...
        "guides": [
          ...
          {
            "title": "Upgrading Katello to 4.12",
            "path": "Upgrading_Project"
          },
          {
            "title": "Tuning Performance",
  ...
  {
    "title": "Foreman 3.5 - Katello 4.7 (unsupported)",
    "path": "3.5",
    "builds": [
      {
        "title": "Katello on EL",
  ...
  {
    "title": "Foreman 3.0 - Katello 4.2 (unsupported)",
    "path": "3.0",
    "builds": [
      {
        "title": "Katello on EL",
